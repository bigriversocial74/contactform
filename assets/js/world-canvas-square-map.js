...
(function (window, document) {
  ...
  addCss('/assets/css/world-canvas-detail-orchestration.css', 'data-world-detail-orchestration-css');
  ...
  addScript('/assets/js/world-canvas-target-drop-intent.js', 'data-world-target-drop-intent-js');
  ...
  addScript('/assets/js/world-canvas-detail-orchestration.js', 'data-world-detail-orchestration-js');
  addScript('/assets/js/world-canvas-zoom-interaction-stability.js', 'data-world-zoom-interaction-stability-js');
})(window, document);
