...
(function(window, document){
  ...
  document.addEventListener('mg:world-delivery-run-created',function(event){var run=event.detail&&event.detail.delivery_run?event.detail.delivery_run:null;if(run&&run.intercept_ready)activeRun=run;});
