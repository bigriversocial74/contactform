document.addEventListener('DOMContentLoaded',function(){
  ...
  async function load(){
    ...
    var order=data.order||{},receipt=data.receipt||{},items=receipt.items_snapshot_json||order.items||[],history=data.history||[],links=data.links||{};
