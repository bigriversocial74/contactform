...
(function (window, document) {
  ...
  async function react(card, button) {
    ...
    try {
      var data = payload(await MG.post('/api/social/engage.php', { action: action, post_id: card.dataset.postId, reaction_type: type, idempotency_key: uuid('newsfeed-reaction') }));
