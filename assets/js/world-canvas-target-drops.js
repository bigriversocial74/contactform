...
(function(window, document){
  ...
  function payloadFromForm(form, action){
    ...
    var csrf = token();
    data.csrf_token = csrf; data._csrf = csrf; data.csrf = csrf;
    data.teaser_enabled = form.elements.teaser_enabled && form.elements.teaser_enabled.checked ? '1' : '0';
    data.signup_required = form.elements.signup_required && form.elements.signup_required.checked ? '1' : '0';
    return data;
  }
