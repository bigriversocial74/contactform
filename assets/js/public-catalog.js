document.addEventListener('DOMContentLoaded', function () {
  ...
  function mediaMarkup(asset, className) {
    ...
    var mime = String(asset.mime_type || '');
    if (type === 'audio') {
    ...
    if (type === 'video') {
      return '<div class="' + escapeHtml(className || 'mg-greeting-media') + '"><strong>Video message</strong><video controls playsinline preload="metadata" src="' + escapeHtml(asset.url) + '" type="' + escapeHtml(mime) + '"></video></div>';
    }
    return '';
  }
