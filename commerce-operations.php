...
$canViewCommerce = mg_has_permission('admin.commerce.view')
...
$page_styles = ['/assets/css/admin-commerce.css'];
$page_scripts = $canViewCommerce ? ['/assets/js/admin-commerce.js'] : [];
...
<section class="mg-commerce-shell" data-commerce-root>
  ...
  <?php if (!$canViewCommerce): ?>
    <section class="mg-app-panel mg-commerce-access"><h2>Commerce operations access is not active.</h2><p>This workspace requires an administrative commerce, payments, subscription, Microgift operations, or tip-reversal permission.</p><a class="mg-btn mg-btn-soft" href="/account-admin.php">Back to admin</a></section>
  <?php else: ?>
