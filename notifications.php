...
$header_mode = 'account';
$page_styles = ['/assets/css/account-commerce.css','/assets/css/account-commerce-fixes.css','/assets/css/communications.css','/assets/css/recipient-notifications.css','/assets/css/message-delivery-proof.css','/assets/css/pwa-notifications.css'];
$page_scripts = ['/assets/js/notifications-page.js','/assets/js/notifications-source-metadata.js','/assets/js/pwa-notifications.js','/assets/js/account-sidebar.js'];
