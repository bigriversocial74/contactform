...
$page_scripts=['/assets/js/merchant-customer-profile.js','/assets/js/merchant-customer-profile-actions-fix.js','/assets/js/merchant-customer-retention-recommendations.js','/assets/js/merchant-customer-agent-timeline.js','/assets/js/merchant-customer-profile-timeout.js'];
