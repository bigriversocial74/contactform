...
$page_scripts=['/assets/js/merchant-customer-profile-lite-controlled.js','/assets/js/merchant-customer-full-profile-controlled.js','/assets/js/merchant-customer-profile.js'];
