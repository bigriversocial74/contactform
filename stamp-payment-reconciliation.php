    ...
    <section class="mg-admin-package-shell" data-stamp-payment-reconciliation-page>
      <header class="mg-admin-package-hero">
        <div>
          ...
          <p>Run checkout QA, review provider/webhook state, open read-only audit timelines, recover paid-but-uncredited purchases, and keep Stamp crediting locked behind verified provider status or admin-only review.</p>
        </div>
...
<script src="/assets/js/admin-stamp-payment-reconciliation.js?v=20260707-stamp-audit-timeline" defer></script>
