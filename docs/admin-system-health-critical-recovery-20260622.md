...
This patch addresses the System Health critical state shown by production after the public API stages.

## Migration health

Production has a consolidated release trigger migration key: `stage_v1_release_trigger_portability`.
