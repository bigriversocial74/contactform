...
$storefrontUrl = '';
$profileUrl = '';
$merchantLocation = 'Primary location pending';
$merchantPhone = 'Phone pending';
$merchantWebsite = 'Website pending';
...
?>
<section class="mg-app-shell mg-design-studio-app" data-design-studio-app data-merchant-only="<?= $canAccessDesignStudio ? 'true' : 'false' ?>">
  ...
  <section class="mg-design-mobile-lock" aria-labelledby="mg-design-mobile-title">
    <div class="mg-design-mobile-card">
      ...
      <p>This tool needs a wide canvas for print templates, media controls, QR placement, and export settings. Open it on a desktop or large laptop screen.</p>
      ...
      <section class="mg-app-panel mg-design-access-panel">
        <div class="mg-app-panel-head">
          <div>
            ...
            <p>This workspace creates print-ready promotional assets from merchant profile data, media files, signed templates, and real QR codes.</p>
          </div>
        </div>
        <div class="mg-app-panel-body">
          <div class="mg-design-access-grid">
            <article>
              ...
              <span>Merchant role or merchant workspace permission.</span>
            </article>
            <article>
              <strong>Current account</strong>
              <span><?= mg_e($merchantEmail !== '' ? $merchantEmail : 'Signed-in account') ?></span>
            </article>
          </div>
    ...
    <div class="mg-app-workspace mg-design-studio-workspace">
      <header class="mg-design-studio-hero">
        <div>
          ...
          <h1>Create print-ready local promotion assets.</h1>
          <p>Choose a format, import merchant media, place real QR codes, and generate signed marketing assets for table tents, flyers, coasters, shelf cards, and inserts.</p>
        </div>
        <div class="mg-design-hero-actions">
          <button type="button" class="mg-btn mg-btn-soft" data-design-save>Save draft</button>
          <button type="button" class="mg-btn mg-btn-primary" data-design-export>Export print package</button>
        </div>
      </header>
      ...
      <section class="mg-design-status-strip" aria-label="Design studio status">
        ...
        <article><span>Template signing</span><strong>Required before export</strong></article>
      </section>
        ...
        <aside class="mg-design-controls" aria-label="Design controls">
          <section class="mg-design-panel">
            <div class="mg-design-panel-head">
              ...
              <div>
                <h2>Format</h2>
                <p>Pick a print product.</p>
              </div>
            </div>
            <div class="mg-design-format-grid" data-format-options>
              <button type="button" class="is-active" data-format="table-tent" data-title="Table Tent" data-size="4 × 6 in folded" data-ratio="portrait"><strong>Table Tent</strong><span>Counter + table promo</span></button>
              <button type="button" data-format="flyer" data-title="Basic Flyer" data-size="8.5 × 11 in" data-ratio="letter"><strong>Basic Flyer</strong><span>Handout + window poster</span></button>
              <button type="button" data-format="coaster" data-title="Coaster" data-size="4 × 4 in" data-ratio="square"><strong>Coaster</strong><span>Bar + event placement</span></button>
              <button type="button" data-format="rack-card" data-title="Rack Card" data-size="4 × 9 in" data-ratio="tall"><strong>Rack Card</strong><span>Front desk takeaway</span></button>
              <button type="button" data-format="receipt-insert" data-title="Receipt Insert" data-size="3 × 6 in" data-ratio="slim"><strong>Receipt Insert</strong><span>Bag + receipt stuffer</span></button>
            </div>
          </section>
          ...
          <section class="mg-design-panel">
            <div class="mg-design-panel-head">
              ...
              <div>
                <h2>Merchant data</h2>
                <p>Loaded from account profile.</p>
              </div>
            </div>
            <div class="mg-design-merchant-card">
              <div class="mg-design-avatar"><?= mg_e($merchantInitial) ?></div>
              <div>
                <strong><?= mg_e($merchantName) ?></strong>
                <span><?= mg_e($merchantHeadline) ?></span>
              </div>
            </div>
            <label>Primary headline
              <input type="text" value="Give local. Claim instantly." data-design-field="headline">
            </label>
            <label>Promotion line
              <textarea rows="3" data-design-field="offer">Scan to unlock today’s featured microgift, local reward, or pre-sale offer.</textarea>
            </label>
            <label>Call to action
              <input type="text" value="Scan to claim your reward" data-design-field="cta">
            </label>
          </section>
          ...
          <section class="mg-design-panel">
            <div class="mg-design-panel-head">
              ...
              <div>
                <h2>Media imports</h2>
                <p>Merchant files and campaign assets.</p>
              </div>
            </div>
          ...
          <section class="mg-design-panel">
            <div class="mg-design-panel-head">
              <span>04</span>
              <div>
                <h2>QR code library</h2>
                <p>Use real claim and campaign codes.</p>
              </div>
            </div>
        ...
        <main class="mg-design-canvas-column" aria-label="Template preview">
          <div class="mg-design-canvas-toolbar">
            <div>
              ...
              <strong data-preview-size>4 × 6 in folded</strong>
            </div>
          ...
          <section class="mg-design-canvas-stage">
            <article class="mg-design-template is-table-tent" data-design-template>
              <div class="mg-design-template-safe-zone">
                <header class="mg-design-template-brand">
                  <span><?= mg_e($merchantName) ?></span>
                  <b>MICROGIFT</b>
                </header>
                ...
                <div class="mg-design-template-qr-row">
                  <div class="mg-design-template-qr" aria-label="QR code placeholder" data-template-qr>
                    <i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i>
                  </div>
                  <div>
                    <strong data-template-qr-label>Featured Gift</strong>
                    <span data-template-qr-kind>Claim QR</span>
                    <small data-template-cta>Scan to claim your reward</small>
                  </div>
                </div>
                <footer>
                  <span><?= mg_e($storefrontUrl !== '' ? $storefrontUrl : ($profileUrl !== '' ? $profileUrl : 'microgifter.com')) ?></span>
                  <span>Powered by Microgifter</span>
                </footer>
              </div>
            </article>
          </section>
        ...
        <aside class="mg-design-print-options" aria-label="Print options">
          <section class="mg-design-panel">
            <div class="mg-design-panel-head">
              ...
              <div>
                <h2>Print setup</h2>
                <p>Production settings.</p>
              </div>
            </div>
            <label>Template source
              <select data-print-setting="template">
                <option>Microgifter signed template</option>
                <option>Merchant uploaded template</option>
                <option>Designer locked template</option>
              </select>
            </label>
            <label>Paper / stock
              <select data-print-setting="stock">
                <option>14pt matte card stock</option>
                <option>16pt gloss card stock</option>
                <option>100lb text flyer</option>
                <option>Waterproof coaster stock</option>
              </select>
            </label>
            <label>Quantity
              <select data-print-setting="quantity">
                <option>25 prints</option>
                <option>50 prints</option>
                <option>100 prints</option>
                <option>250 prints</option>
                <option>500 prints</option>
              </select>
            </label>
            <div class="mg-design-toggle-list">
              <label><input type="checkbox" checked> Include bleed</label>
              <label><input type="checkbox" checked> Add crop marks</label>
          ...
          <section class="mg-design-panel">
            ...
            <div class="mg-design-export-list">
              ...
              <article class="is-warning"><span></span><div><strong>Signed template</strong><small>Pending backend signature</small></div></article>
              ...
              <article class="is-warning"><span></span><div><strong>Print proof</strong><small>Needs approval before production</small></div></article>
            </div>
          </section>
          ...
          <section class="mg-design-panel mg-design-proof-panel">
            <div>
              ...
              <strong data-proof-estimate>Ready in studio</strong>
              <p>Generate a print package when QR verification, template signing, and merchant approval are complete.</p>
            </div>
