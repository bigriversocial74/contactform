...
$page_section = 'agent';
$header_mode = 'agent';
$agent_tab = 'design-studio';
$page_body_class = 'mg-design-studio-page mg-design-custom-page';
$page_styles = [
...
$canAccessDesignStudio = $user && (
    ...
    || mg_has_permission('merchant.design_studio.view')
    || mg_has_permission('merchant.design_studio.manage')
);
...
>
  <aside class="mg-design-sidebar" aria-label="Design Studio sidebar">
    <div class="mg-design-sidebar-brand-row">
      <a class="mg-brand mg-sidebar-logo mg-design-sidebar-logo" href="/index.php" aria-label="Microgifter home">
        <img src="/images/logo_main_drk.png" alt="Microgifter">
        <span class="mg-sidebar-logo-text">Microgifter</span>
      </a>
    </div>

    <div class="mg-design-sidebar-title">
      <span class="mg-design-eyebrow">Design Studio</span>
      <h2>Print + social assets</h2>
      <p><?= mg_e($merchantName) ?></p>
    </div>

    <?php if ($canAccessDesignStudio && $designStudioReady): ?>
      <div class="mg-design-controls" aria-label="Design controls">
    ...
    <?php else: ?>
      <nav class="mg-design-sidebar-fallback" aria-label="Workspace links">
        <a href="/agent.php">Workspace</a>
        <a href="/account.php">Business profile</a>
        <a href="/merchant-media.php">Media library</a>
      </nav>
    <?php endif; ?>
  </aside>
  ...
  <section class="mg-design-main-shell">
    <header class="mg-design-page-header">
      <div>
        <span class="mg-design-eyebrow">Merchant Marketing Studio</span>
        <h1>Create print and social promotion assets.</h1>
        <p>Scan brand assets, place real QR codes, save reusable templates, and queue production exports.</p>
      </div>
      <?php if ($canAccessDesignStudio && $designStudioReady): ?>
        <div class="mg-design-header-actions">
    ...
    <?php if (!$canAccessDesignStudio): ?>
      <div class="mg-design-studio-workspace mg-design-message-workspace">
    ...
    <?php else: ?>
      <div class="mg-design-studio-workspace">
