...
$checks=[
 ...
 'privacy hash secret is required'=>str_contains($core,'MG_PRIVACY_HASH_KEY')&&str_contains($core,'Privacy hashing is not configured'),
 ...
 'public profile uses installed hidden state'=>str_contains($core,'status="hidden"')&&!str_contains($core,'public_profiles SET status="disabled"'),
