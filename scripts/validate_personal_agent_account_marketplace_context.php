...
try {
    ...
    $expect(
        ...
        'Personal agent loads permission-safe knowledge and marketplace response layers'
    );
    $expect(
    ...
    foreach (['code_last4', 'phone_ciphertext', 'phone_hash', 'address_line_1', 'address_line_2', 'source_reference', 'payment_method_id'] as $blockedMarker) {
        $expect(
            ...
            && !str_contains($marketplaceCards, $blockedMarker)
            && !str_contains($marketplaceResponse, $blockedMarker),
