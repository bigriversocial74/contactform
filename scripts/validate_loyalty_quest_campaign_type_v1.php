...
$checks[]=['name'=>'merchant isolation','ok'=>substr_count($api,'merchant_user_id')>=7&&str_contains($api,"campaign_type='loyalty_quest'")&&str_contains($api,'mg_merchant_require_permission')];
