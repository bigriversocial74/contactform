...
$required=[
 ...
 'includes/campaign-types.php','includes/merchant-campaigns-view.php','merchant-campaigns.php','scripts/validate_loyalty_quest_campaign_type_v1.php','.github/workflows/loyalty-quest-campaign-type-validation.yml',
];
...
$checks[]=['name'=>'main campaign option','ok'=>str_contains($view,'mg_campaign_type_options(true)')&&str_contains($page,'/assets/js/loyalty-quest-campaign-type.js')&&str_contains($js,"option.value='loyalty_quest'")];
