...
$checks = [
    ...
    'Stamp uses exactly three summary cards' => substr_count($stamp, 'mg-stamp-summary-card') === 3 && str_contains($stamp, 'mg-stamp-item-card') && str_contains($stamp, 'mg-stamp-rules-card') && str_contains($stamp, 'mg-stamp-status-card'),
