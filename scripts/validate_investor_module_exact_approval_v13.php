...
$pass(str_contains($service,'investment-audit-hardening-v13.php'),'Service loader activates exact-approval hardening v13.');
...
$pass($all($governance,['mg_investment_governance_dashboard_audited_v2','mg_investment_governance_save_meeting_audited_v2','mg_investment_governance_save_packet_document_audited_v2','mg_investment_governance_save_consent_audited_v2','mg_investment_governance_save_notice_audited_v4','mg_investment_governance_save_right_audited_v3','mg_investment_governance_save_obligation_audited_v2']),'Governance routes every investor-visible transition through v13.');
...
$pass(str_contains($workflow,'validate_investor_module_exact_approval_v13.php'),'Full audit workflow runs the v13 adversarial contract.');

require_once $root.'/includes/investment/investment-service.php';
foreach(['mg_investment_governance_dashboard_audited_v2','mg_investment_dataroom_save_document_audited_v2','mg_investment_qa_save_audited_v2','mg_investment_communication_save_audited_v3','mg_investment_governance_save_packet_document_audited_v2','mg_investment_governance_save_notice_audited_v4','mg_investment_governance_save_obligation_audited_v2'] as $function)$pass(function_exists($function),'Loaded service exposes '.$function.'.');

if($failures!==[]){foreach($failures as $failure)fwrite(STDERR,"[EXACT APPROVAL FAILURE] {$failure}\n");exit(1);}echo "Investor module exact approval v13: {$checks}/{$checks} checks passed.\n";
