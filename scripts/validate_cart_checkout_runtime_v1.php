...
$checks=[
    ...
    'strict_session_recovery'=>str_contains($sessionFoundation,'return mg_payment_checkout_session_payload($existing,$orderPublicId,true)')&&str_contains($sessionFoundation,'An active checkout session already exists for this order and provider.')&&str_contains($sessionFoundation,'mg_payment_expire_checkout_sessions'),
