...
$page=$read('quests.php');$merchant=$read('quest-merchant.php');$route=$read('loyalty-quest.php');$detail=$read('api/public/loyalty-quest/detail.php');$api=$read('api/public/loyalty-quests.php');$js=$read('assets/js/loyalty-quest-marketplace.js');$css=$read('assets/css/loyalty-quest-marketplace.css');$mapCss=$read('assets/css/loyalty-quest-map.css');
...
$checks[]=['name'=>'participant quest route handoff','ok'=>str_contains($route,'data-loyalty-quest-participant')&&str_contains($route,'data-campaign-ref')&&str_contains($route,'/api/public/loyalty-quest/detail.php')===false&&str_contains($detail,'mg_lqp_campaign')&&str_contains($detail,'can_start')&&str_contains($detail,'can_submit')];
