...
$checks[] = ['name'=>'merchant review workspace','ok'=>str_contains($reviewPage,"$merchantView = 'quest_reviews'")&&str_contains($reviewView,'data-quest-review-workspace')&&str_contains($reviewView,'aria-live="polite"')&&str_contains($reviewView,'<dialog')&&str_contains($reviewJs,'data-dialog-decision')&&str_contains($reviewCss,'@media(max-width:680px)')];
...
$checks[] = ['name'=>'safe historical detail state','ok'=>str_contains($detail,'availability')&&str_contains($detail,'can_start')&&str_contains($detail,'can_submit')&&str_contains($detail,'$enforceAvailability')===false&&str_contains($participant,'$enforceAvailability = true')];
