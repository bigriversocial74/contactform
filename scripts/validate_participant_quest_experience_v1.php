...
$checks[] = ['name'=>'compact dropdown omits quest shortcuts','ok'=>!str_contains($accountNav,'/my-quests.php')&&!str_contains($accountNav,'/merchant-loyalty-quests.php')&&str_contains($accountNav,'/merchant-quest-reviews.php')&&str_contains($merchantNav,"'quest_reviews' => 'loyalty_quests'")&&str_contains($merchantNav,"'loyalty_quests' => ['Loyalty Quests'")];
