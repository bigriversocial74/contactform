...
$lifecycleTest=(string)@file_get_contents($root.'/scripts/test_mcp_automation_definitions_phase4b.php');
$checks=[
 ...
 'clean_database_lifecycle'=>str_contains($lifecycleTest,'phase3b_build_fixture')&&str_contains($lifecycleTest,'mg_mcp_automation_run_simulation')&&str_contains($lifecycleTest,"status='proposed'")&&str_contains($lifecycleTest,'Simulation created an action receipt.'),
