...
$checks[]=['name'=>'scheduled lifecycle derivation','ok'=>str_contains($api,'mg_lqm_lifecycle_state')&&str_contains($api,"return 'scheduled'")&&str_contains($js,'q.lifecycle_state')&&str_contains($view,'data-lq-kpi-scheduled')];
...
$checks[]=['name'=>'participant and activity detail','ok'=>str_contains($js,'/api/merchant/campaign-detail.php?campaign_id=')&&str_contains($js,'campaign.contacts')&&str_contains($js,'campaign.events')&&str_contains($js,'View participants in CRM')];
