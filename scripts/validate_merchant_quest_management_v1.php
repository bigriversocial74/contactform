...
$checks[]=['name'=>'merchant navigation','ok'=>str_contains($nav,"'loyalty_quests' => 'campaigns'")&&str_contains($nav,"'campaigns' => ['Campaigns'")&&str_contains($workspace,'mg_merchant_navigation_sidebar($merchantView)')];
