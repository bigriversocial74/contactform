...
$checks[]=['name'=>'scheduled lifecycle derivation','ok'=>str_contains($api,'lifecycle_state')&&str_contains($api,"status']==='active'")&&str_contains($api,"'scheduled'")&&str_contains($js,'lifecycle_state')&&str_contains($view,'value="scheduled"')];
