...
$assert('Campaign API keeps watch provider and milestones',str_contains($campaignsApi,'mg_campaign_watch_provider')&&str_contains($campaignsApi,'mg_campaign_watch_milestones')&&str_contains($campaignsApi,'mg_campaign_dynamic_milestones'));
