...
$confirmedAwayNeedle='if (!$requiresConfirmation && !empty($presence[\'merchant_away\'])';
if(!str_contains($entry,$confirmedAwayNeedle))$errors[]='Unattended entry messaging must wait until store-switch confirmation is complete.';
