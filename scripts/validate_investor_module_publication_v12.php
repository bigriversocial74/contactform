...
$pass(str_contains($v12,'A changed published investment document must be saved as an approved version'),'Changed published official documents cannot bypass approval.');
...
$pass(str_contains($v12,'A changed published tax document must be saved as an approved version'),'Changed published tax documents cannot bypass approval.');
