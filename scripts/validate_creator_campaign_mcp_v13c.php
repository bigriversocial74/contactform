...
$owner=$read('includes/mcp-creator-campaign-actions/owner-service.php').$read('includes/mcp-creator-campaign-actions/owner-page-view.php').$read('account-creator-campaign-actions.php');
...
$add('Dynamic OAuth remains read-only while preregistered clients may be approval-gated',str_contains($oauth,'$registrationType === \'dynamic\'')&&str_contains($oauth,"['read', 'draft', 'approval_gated']")&&str_contains($oauth,'owner_execution_required'),5);
