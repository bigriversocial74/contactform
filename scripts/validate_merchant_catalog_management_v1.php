...
'immutable_versions'=>str_contains($builder,"VALUES (?,?,?,'published'")&&str_contains($builder,"version_status='retired'")&&str_contains($builder,"product_type=?,slug=?,current_version_id=?,status='published'")&&str_contains($detail,'ORDER BY v.version_number DESC'),
