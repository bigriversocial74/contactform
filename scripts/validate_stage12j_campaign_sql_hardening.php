...
$checks = [
    ...
    'hardening_is_pdo_safe' => !str_contains($hardeningSql, 'DELIMITER') && !str_contains($hardeningSql, 'CREATE PROCEDURE'),
    'hardening_adds_indexes' => str_contains($hardeningSql, 'idx_campaign_events_merchant_type_created') && str_contains($hardeningSql, 'idx_wallet_items_source_id') && str_contains($hardeningSql, 'idx_campaigns_slug_active'),
