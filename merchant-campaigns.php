...
$page_scripts = ['/assets/js/merchant-workspace.js','/assets/js/stage12-customer-refund-campaign-type.js','/assets/js/stage12-campaign-embed-tools.js','/assets/js/campaign-embed-analytics-links.js','/assets/js/stage12-survey-feedback-reward.js'];
