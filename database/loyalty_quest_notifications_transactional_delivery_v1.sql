...
ALTER TABLE message_delivery_jobs
  ...
  ADD KEY IF NOT EXISTS idx_message_delivery_jobs_merchant (merchant_user_id,status,next_attempt_at,id),
  ADD KEY IF NOT EXISTS idx_message_delivery_jobs_campaign (campaign_id,status,created_at);

INSERT INTO schema_migrations (migration_key,description,checksum,applied_at)
VALUES ('loyalty_quest_notifications_transactional_delivery_v1','Loyalty Quest notification delivery attempts, callbacks, suppression, scheduling, and merchant/campaign evidence.',NULL,NOW())
