...
$user = mg_require_auth('/signin.php', '/creator-campaign-deliverables.php');
$page_title = 'My Creator Deliverables | Microgifter';
$page_section = 'account';
$header_mode = 'account';
$accountView = 'creator-campaigns';
$page_body_class = 'mg-creator-deliverables-account-page mg-creator-campaign-ui-v11';
$page_styles = [
...
$page_manifest = [
    'id' => 'creator-campaign-deliverables',
    'title' => $page_title,
    ...
    'onboarding' => ['enabled' => false, 'page' => 'creator-campaign-deliverables', 'sections' => []],
];
...
<section class="mg-account-page">
  <div class="mg-account-layout">
    ...
    <section class="mg-account-shell">
      <?php require __DIR__ . '/includes/creator-campaign-deliverables-view.php'; ?>
    </section>
  </div>
</section>
