...
<section class="mg-app-shell mg-admin-app" data-admin-ai>
  ...
  <div class="mg-app-workspace mg-admin-workspace">
    <section class="mg-ai-admin-page">
      ...
      <section class="mg-ai-security-notice"><strong>Secure deployment requirement</strong><p>Set provider keys in the hosting environment. Do not paste production keys into source code or expose them to the browser.</p><pre>MG_ANTHROPIC_API_KEY=...
MG_OPENAI_API_KEY=...
MG_GEMMA_API_KEY=...
MG_KIMI_API_KEY=...
