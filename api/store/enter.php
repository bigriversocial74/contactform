...
try {
    ...
    mg_rate_limit('store.enter', 'user:' . (int)$user['id'], 60, 60);
    $result = mg_store_enter_post($pdo, (int)$user['id'], $postId, $switchStore);
    ...
    mg_security_log('error', 'store_canvas.enter_failed', 'Customer enter store failed.', ['exception_class'=>$error::class], (int)$user['id']);
