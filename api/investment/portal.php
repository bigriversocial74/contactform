...
try {
    if ($method==='GET') {
        ...
        mg_ok(mg_investment_portal_data_v5_audited($pdo,$user),'Investor Portal loaded.');
    }
    ...
    $result=match($action) {
        'submit_diligence'=>mg_investment_portal_submit_diligence_v5_audited($pdo,$user,$input),
        'submit_interest'=>mg_investment_portal_submit_interest_v5_audited($pdo,$user,$input),
        'acknowledge_notice'=>mg_investment_portal_acknowledge_notice_v5_audited($pdo,$user,$input),
