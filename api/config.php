...
$config = [
    ...
    'security' => [
        ...
        'session_cookie_secure' => strtolower((string) mg_env('MG_SESSION_COOKIE_SECURE', 'auto')),
        'session_cookie_samesite' => (string) mg_env('MG_SESSION_COOKIE_SAMESITE', 'Lax'),
        'session_cookie_path' => (string) mg_env('MG_SESSION_COOKIE_PATH', '/'),
        'session_cookie_domain' => (string) mg_env('MG_SESSION_COOKIE_DOMAIN', ''),
