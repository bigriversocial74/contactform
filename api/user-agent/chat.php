...
// Runtime chain: mg_personal_agent_chat_with_credit_response()
// -> mg_personal_agent_chat_with_merchant_opportunities()
...
mg_user_agent_api_run(
    static fn(): array => mg_personal_agent_chat_with_credit_response(
        mg_db(),
        (int) $user['id'],
        $input
    )
