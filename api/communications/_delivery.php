...
function mg_delivery_enqueue(PDO $pdo,array $input,?callable $failureHook=null): array
{
    ...
    if($key===''||strlen($key)>190||$template===''||$recipient<1||!in_array($channel,['in_app','email','sms','webhook'],true))throw new MgDeliveryException('Invalid message delivery request.',422);
