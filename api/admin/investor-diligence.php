...
try {
    ...
    $result=match($action) {
        ...
        'save_document'=>mg_investment_dataroom_save_document_audited_v3($pdo,$actor,$input),
        'save_request'=>mg_investment_diligence_admin_save_request_audited($pdo,$actor,$input),
        'save_qa'=>mg_investment_qa_save_audited_v3($pdo,$actor,$input),
        'save_meeting'=>mg_investment_meeting_save_audited($pdo,$actor,$input),
        'save_communication'=>mg_investment_communication_save_audited_v4($pdo,$actor,$input),
