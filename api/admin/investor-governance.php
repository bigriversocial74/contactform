...
try {
    ...
    if ($method==='GET') {
        ...
        mg_ok(mg_investment_governance_dashboard_audited_v2($pdo,$_GET),'Investor governance data loaded.');
    }
    ...
    $result=match($action) {
        ...
        'save_meeting'=>mg_investment_governance_save_meeting_audited_v4($pdo,$actor,$input),
        ...
        'save_packet_document'=>mg_investment_governance_save_packet_document_audited_v3($pdo,$actor,$input),
        'save_minutes'=>mg_investment_governance_save_minutes_audited($pdo,$actor,$input),
        'save_consent'=>mg_investment_governance_save_consent_audited_v3($pdo,$actor,$input),
        ...
        'save_right'=>mg_investment_governance_save_right_audited_v4($pdo,$actor,$input),
        'save_obligation'=>mg_investment_governance_save_obligation_audited_v4($pdo,$actor,$input),
        ...
        'save_tax_document'=>mg_investment_governance_save_tax_document_audited_v4($pdo,$actor,$input),
        'save_notice'=>mg_investment_governance_save_notice_audited_v6($pdo,$actor,$input),
