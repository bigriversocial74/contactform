...
try {
    mg_ok(mg_share_market_approval_sql_queue(mg_db(), $user), 'Share Market approval queue loaded.');
} catch (Throwable $e) {
    mg_security_log('error', 'share_market.approval_queue_failed', 'Unable to load Share Market approval queue.', ['exception_class' => $e::class], (int)$user['id']);
