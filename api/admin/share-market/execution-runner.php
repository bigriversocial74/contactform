...
try {
    ...
    mg_ok(['execution' => mg_share_market_execution_runner_stub_with_gate(mg_db(), $requestId, $user, $runMode)], 'Release gate blocked execution. No share action was executed.');
