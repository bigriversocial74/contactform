...
try {
    ...
    $snapshot = mg_share_market_sql_submit_enrollment($pdo, $payload, (int)$user['id']);
    mg_share_market_notify_enrollment_submitted($pdo, (int)$user['id'], $snapshot);
    mg_ok($snapshot, 'Share Market request submitted.', 201);
