...
function mg_developer_api_setup_payload(array $summary, array $apps, array $keys, array $programs): array
{
    ...
    $steps = [
        ...
        ['key'=>'webhook','label'=>'Configure webhook URL','done'=>$hasWebhook,'detail'=>'Add a webhook URL so lifecycle callbacks can be delivered.','action_label'=>'Webhook docs','action_href'=>'/docs/stage-api-5-developer-webhooks.md'],
        ['key'=>'webhook_secret','label'=>'Rotate webhook signing secret','done'=>$hasWebhookSecret,'detail'=>'Generate a reveal-once secret and store it in the developer backend before live launch.','action_label'=>'Webhook secrets','action_href'=>'/docs/stage-api-12-webhook-secrets-hardening.md'],
