...
try {
    $analytics = mg_creator_campaign_analytics_build($pdo, $user, $_GET, 'merchant');
    ...
    mg_fail_unexpected($error, 'creator.campaign.analytics.merchant_failure', 'Unable to load Creator Campaign analytics.', 500, [], $actorUserId);
}
