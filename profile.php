    ...
    <div class='mg-invest-wrap mg-invest-browser-frame'>
      ...
      <section class='mg-invest-summary-grid' aria-label='Profile metrics'>
        ...
        <article class='mg-invest-card mg-invest-chart-card'>
          ...
          <div class='mg-invest-chart-axis' data-invest-market-chart-axis><span>Start</span><span>Mid</span><span>Now</span></div>
        </article>

        <article class='mg-invest-card mg-invest-demand-card'>
          <div class='mg-invest-card-head'>
            <span>Demand Score</span>
            <strong><span data-invest-demand-score>—</span> <em data-invest-demand-label>—</em></strong>
          </div>
          <div class='mg-invest-demand-body'>
            <div class='mg-invest-demand-ring' data-invest-demand-ring><span data-invest-demand-ring-score>—</span></div>
            <dl>
              <div><dt>Scarcity</dt><dd data-invest-score-scarcity>—</dd></div>
              <div><dt>Redemptions</dt><dd data-invest-score-redemptions>—</dd></div>
              <div><dt>Velocity</dt><dd data-invest-score-velocity>—</dd></div>
              <div><dt>Social Buzz</dt><dd data-invest-score-social>—</dd></div>
              <div><dt>Sentiment</dt><dd data-invest-score-sentiment>—</dd></div>
            </dl>
          </div>
          <small data-invest-updated>Loading data…</small>
        </article>
      </section>

      <nav class='mg-invest-tabs' aria-label='Merchant profile sections'>
      ...
      <div class='mg-invest-layout' id='overview'>
        <main class='mg-invest-main'>
          <section class='mg-invest-panel mg-hidden' data-profile-storefront-section id='products' aria-labelledby='mg-profile-storefront-title'>
            <div class='mg-invest-section-head'>
              <div>
                <span class='mg-invest-eyebrow'>Featured Experiences</span>
                <h2 id='mg-profile-storefront-title' data-storefront-name>Featured products</h2>
                <p class='mg-profile-section-intro mg-hidden' data-storefront-headline></p>
              </div>
              <a class='mg-invest-link mg-hidden' data-storefront-link>View all products →</a>
            </div>

            <article class='mg-storefront-card mg-invest-storefront-card'>
              ...
              <div class='mg-storefront-body'>
                ...
                <p data-storefront-description>Browse tokenized local experiences from this merchant.</p>
              </div>
            </article>
