...
$header_mode='agent';
$agent_tab='messages';
$page_styles=['/assets/css/communications.css','/assets/css/messages-source-metadata.css','/assets/css/message-delivery-proof.css','/assets/css/messages-redesign.css','/assets/css/messages-crm-pro.css','/assets/css/messages-chat-scroll-fix.css','/assets/css/messages-chat-polish.css','/assets/css/messages-thread-actions.css','/assets/css/messages-final-polish.css','/assets/css/messages-commerce-team.css'];
$page_scripts=['/assets/js/messages-center.js','/assets/js/messages-crm-pro.js','/assets/js/messages-final-polish.js','/assets/js/messages-commerce-team.js'];
