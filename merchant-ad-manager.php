...
$page_scripts = ['/assets/js/sponsored-campaign-card.js','/assets/js/ad-health-alerts.js','/assets/js/merchant-ad-manager.js','/assets/js/merchant-ad-picker-groups.js','/assets/js/merchant-ad-lifecycle-guard.js'];
$page_manifest = [
