          ...
          <div class="mg-ads-create-layout">
            <article class="mg-ads-panel mg-ads-create-panel">
              ...
              <form class="mg-ads-form" data-ad-form onsubmit="return false;">
                <div class="mg-ads-product-picker" data-product-picker-wrap>
                  <div class="mg-ads-field">
                    ...
                    <small class="mg-ads-field-hint">Optional. Applying a product fills the existing campaign fields and preview. If products fail to load, the campaign builder still works manually.</small>
                  </div>
