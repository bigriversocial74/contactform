...
$page_scripts = ['/assets/js/stamp-checkout.js?v=20260706-stamp-provider-checkout'];
      ...
      <section class="mg-app-panel mg-stamp-ledger-panel">
        <div class="mg-app-panel-head mg-stamp-ledger-panel-head">
          <div>
            ...
            <p>Review the registered Stamp bundle, continue to the secure payment provider, and receive ledger credit only after the verified webhook confirms payment.</p>
          </div>
        </div>
