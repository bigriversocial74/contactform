...
<main class="mg-lqp-page" data-loyalty-quest-participant data-campaign-ref="<?= mg_e($ref) ?>">
  <section class="mg-lqp-loading" data-lqp-loading><div class="mg-lqp-spinner" aria-hidden="true"></div><p>Loading Loyalty Quest…</p></section>
  ...
  <div data-lqp-content hidden>
    <section class="mg-lqp-hero">
      <div class="mg-lqp-hero-media"><img data-lqp-image src="/assets/images/loyalty-quest-placeholder.svg" alt="" fetchpriority="high"></div>
      <div class="mg-lqp-hero-copy">
        <div class="mg-lqp-hero-links"><a class="mg-lqp-back" href="/quests.php">← Explore quests</a><a class="mg-lqp-my-quests" href="/my-quests.php">My quests</a></div>
    ...
    <section class="mg-lqp-layout">
      <div class="mg-lqp-main">
        <section class="mg-lqp-panel">
          ...
          <div class="mg-lqp-eligibility" data-lqp-eligibility-card hidden><strong>Eligibility and terms</strong><p data-lqp-eligibility></p></div>
          ...
          <div class="mg-lqp-progress" data-lqp-progress hidden><div><span>Progress</span><strong data-lqp-progress-label>0 of 1</strong></div><div class="mg-lqp-progress-track"><span data-lqp-progress-bar></span></div><small data-lqp-cooldown hidden></small></div>
        </section>
        ...
        <section class="mg-lqp-panel" data-lqp-action-panel>
          ...
          <form class="mg-lqp-start" data-lqp-start hidden>
            ...
            <div class="mg-lqp-start-location" data-lqp-start-location-field hidden><p>Location access confirms that this regional quest is available to you.</p><button type="button" data-lqp-start-location-button>Check my location</button><small data-lqp-start-location-result></small></div>
            <button type="submit" data-lqp-start-button>Start Loyalty Quest</button>
          </form>
          <form class="mg-lqp-proof-form" data-lqp-proof-form hidden>
            <div class="mg-lqp-method" data-lqp-code-field hidden><label><span data-lqp-code-label>Quest code</span><input name="code" autocomplete="one-time-code" maxlength="1000" placeholder="Enter or scan code"></label><button type="button" data-lqp-camera>Scan QR</button></div>
            ...
            <label data-lqp-reference-field hidden><span>Purchase or reference ID</span><input name="reference_id" maxlength="190" placeholder="Order, receipt, referral, or transaction reference"></label>
...
<div class="mg-lqp-scanner" data-lqp-scanner hidden aria-hidden="true"><div class="mg-lqp-scanner-dialog" role="dialog" aria-modal="true" aria-labelledby="mg-lqp-scanner-title" tabindex="-1"><button type="button" data-lqp-scanner-close aria-label="Close scanner">×</button><h2 id="mg-lqp-scanner-title">Scan quest QR code</h2><video data-lqp-video playsinline muted></video><canvas data-lqp-canvas hidden></canvas><p data-lqp-scanner-status>Point your camera at the quest QR code.</p></div></div>
