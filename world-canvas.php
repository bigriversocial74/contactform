...
$page_styles = ['/assets/css/world-canvas.css','/assets/css/world-canvas-attraction.css'];
$page_scripts = ['/assets/js/world-canvas.js','/assets/js/world-canvas-overlays.js'];
$page_manifest = [
    'id' => 'world-canvas',
    'title' => $page_title,
