...
$page_scripts=['/assets/js/privacy-center-v1.js?v=1.1.0'];
$user=mg_current_user();
$csrfToken=$user ? mg_csrf_token() : '';
require __DIR__ . '/includes/header.php';
?>
<section class="mg-app-shell mg-account-app" data-privacy-center data-authenticated="<?= $user?'true':'false' ?>" data-csrf-token="<?= mg_e($csrfToken) ?>">
