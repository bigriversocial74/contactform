...
$page_styles = ['/assets/css/account-commerce.css','/assets/css/communications.css','/assets/css/notification-preferences.css'];
  ...
  <div class="mg-account-layout">
    ...
    <section class="mg-account-shell mg-preferences-page">
      <header class="mg-preferences-hero">
        <div><span class="mg-eyebrow">Communication controls</span><h1>Notification preferences</h1><p>Choose how and when Microgifter contacts you about gifts, messages, claims, deliveries, and distribution activity.</p></div>
        <a class="mg-btn mg-btn-soft" href="/notifications.php">Back to notifications</a>
      </header>
      <section class="mg-preferences-card">
        <div class="mg-preferences-grid-head"><span>Notification type</span><span>In app</span><span>Email</span><span>SMS</span><span>Push</span><span>Digest</span><span></span></div>
