...
$ctaLabel = trim((string)($s['splash_cta_label'] ?? 'Open app')) ?: 'Open app';
$hasSplashBackground = $background !== '';
?>
<!doctype html>
<html lang="en">
<head>
