...
final class MerchantAutomationControlCenterTest extends TestCase
{
...

    {
        ...
        foreach (['/merchant-automation.php','>Controls<','approval-gated'] as $needle) self::assertStringContainsString($needle,$retention);
        foreach (['/merchant-automation.php','Automation controls','data-cp-automation-controls'] as $needle) self::assertStringContainsString($needle,$customer);
