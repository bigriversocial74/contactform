...
final class PersonalGiftingWorkflowsPhase3Test extends TestCase
{
    ...
    public function testWorkflowApisAreProtectedAndUiPreservesComposer(): void
    {
        ...
        $workspace=$this->read('includes/agent-workspace.php');$sidebar=$this->read('includes/personal-agent-sidebar.php');
        foreach(['data-agent-composer','data-phase3-schema-ready','workspace-workflow-dialogs.php'] as $needle) self::assertStringContainsString($needle,$workspace);
        self::assertStringContainsString('/design-calendar.php',$sidebar);
