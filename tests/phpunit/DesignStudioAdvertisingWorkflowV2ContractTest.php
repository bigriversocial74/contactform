...
final class DesignStudioAdvertisingWorkflowV2ContractTest extends TestCase
{
...

    {
        ...
        foreach (['data-calendar-bulk','data-calendar-bulk-apply','dragstart','data-calendar-filter','design-studio:schedule-context'] as $marker) self::assertStringContainsString($marker,$javascript);
