...
final class MultiAgentRuntimeMemoryV1ContractTest extends TestCase
{
    ...
    public function testRuntimeUsesOwnedAgentsSafeMemoryAndAiCredits(): void
    {
        $root = dirname(__DIR__, 2);
        ...
        self::assertStringContainsString('mg_task_agent_memory_system_response', $service);
    ...
    public function testSelectedAgentUsesOnePersistentChatCanvasWithTabbedManagement(): void
    {
        ...
        foreach ([$workspace, $script, $layout, $page] as $value) {
        ...
        self::assertStringContainsString("'chat'", $script);
        self::assertStringContainsString("'onboarding'", $script);
        self::assertStringContainsString("'save_draft'", $script);
        self::assertStringContainsString("'archive_memory'", $script);
        ...
        self::assertStringContainsString('/assets/js/multi-agent-runtime.js?v=1.5.0', $page);
