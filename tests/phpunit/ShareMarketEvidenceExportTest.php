...
final class ShareMarketEvidenceExportTest extends TestCase
{
    ...
    public function testAuditConsoleInjectsExportPanelAndDownload(): void
    {
        $js = (string)file_get_contents(dirname(__DIR__, 2) . '/assets/js/share-market-execution-audit.js');

        self::assertStringContainsString('data-share-export-panel', $js);
        self::assertStringContainsString('data-share-export-download', $js);
