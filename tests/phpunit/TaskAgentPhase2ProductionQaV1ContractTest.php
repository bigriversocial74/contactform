...
final class TaskAgentPhase2ProductionQaV1ContractTest extends TestCase
{
    ...
    public function testDeterministicRoutingPrecedesAndUsuallyAvoidsPaidAi(): void
    {
        ...
        $routePosition=strpos($runtime,'mg_task_agent_shortlist_route');
        ...
        $compact=$this->compact($runtime);
        self::assertStringContainsString('if(!$result&&$aiReason!==\'\')',$compact);
        self::assertStringContainsString('mg_multi_agent_runtime_messages($pdo,$userId,(int)$agent[\'id\'],(int)$thread[\'id\'],8)',$compact);
