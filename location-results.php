...
?>
<style>
.location-results-page,.location-results-page *{box-sizing:border-box}.location-results-page{background:#f8fafc;color:#071225;min-height:100vh}.lr-hero{position:relative;overflow:hidden;padding:76px 0 42px;border-bottom:1px solid #e2e8f0;background:radial-gradient(circle at 18% 10%,rgba(237,233,254,.72),transparent 34%),radial-gradient(circle at 82% 12%,rgba(219,234,254,.72),transparent 30%),linear-gradient(180deg,#fff,#f8fafc)}.lr-hero:before{content:"";position:absolute;inset:0;pointer-events:none;opacity:.58;background:linear-gradient(90deg,rgba(15,23,42,.035) 1px,transparent 1px),linear-gradient(0deg,rgba(15,23,42,.035) 1px,transparent 1px);background-size:72px 72px}.lr-container{position:relative;z-index:2;width:min(1180px,92%);margin:0 auto}.lr-kicker{display:inline-flex;align-items:center;min-height:30px;padding:0 12px;border:1px solid #dbe5f1;border-radius:999px;background:#fff;color:#7c3aed;font-size:12px;font-weight:950;letter-spacing:.06em;text-transform:uppercase}.lr-hero-grid{display:grid;grid-template-columns:minmax(0,1.05fr) minmax(280px,.42fr);gap:34px;align-items:end;margin-top:18px}.lr-hero h1{margin:0;font-size:clamp(42px,6vw,78px);line-height:.92;letter-spacing:-.075em;color:#071225}.lr-hero p{max-width:660px;margin:18px 0 0;color:#64748b;font-size:16px;line-height:1.6;font-weight:650}.lr-stat-card{padding:24px;border:1px solid #dbe5f1;border-radius:26px;background:rgba(255,255,255,.86);box-shadow:0 24px 70px rgba(15,23,42,.1);backdrop-filter:blur(14px)}.lr-stat-card strong{display:block;font-size:46px;line-height:1;letter-spacing:-.06em;color:#071225}.lr-stat-card span{display:block;margin-top:8px;color:#64748b;font-size:12px;font-weight:950;text-transform:uppercase;letter-spacing:.07em}.lr-results{padding:42px 0 88px}.lr-layout{display:grid;grid-template-columns:minmax(240px,25%) minmax(0,75%);gap:34px;align-items:start}.lr-state-sidebar{position:sticky;top:92px;align-self:start;padding:18px;border:1px solid #dbe5f1;border-radius:24px;background:#fff;box-shadow:0 18px 46px rgba(15,23,42,.06)}.lr-state-sidebar h2{margin:0;color:#071225;font-size:20px;line-height:1;letter-spacing:-.045em}.lr-state-sidebar p{margin:8px 0 16px;color:#64748b;font-size:12px;line-height:1.45;font-weight:700}.lr-state-list{display:grid;gap:8px;max-height:calc(100vh - 210px);overflow:auto;padding-right:2px}.lr-state-link{min-height:42px;display:flex;align-items:center;justify-content:space-between;gap:10px;padding:0 11px;border:1px solid #e2e8f0;border-radius:14px;background:#f8fafc;color:#071225;text-decoration:none;font-size:13px;font-weight:950}.lr-state-link:hover{background:#f5f3ff;border-color:#ddd6fe;color:#6d28d9}.lr-state-link.is-active{background:#071225;border-color:#071225;color:#fff}.lr-state-label{display:flex;align-items:center;gap:9px;min-width:0}.lr-state-code{width:30px;height:30px;display:grid;place-items:center;border-radius:10px;background:#fff;color:#475569;font-size:11px;font-weight:950}.lr-state-link.is-active .lr-state-code{background:rgba(255,255,255,.14);color:#fff}.lr-state-name{overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.lr-state-count{min-width:25px;height:25px;display:grid;place-items:center;padding:0 7px;border-radius:999px;background:#e2e8f0;color:#475569;font-size:11px;font-weight:950}.lr-state-link.is-active .lr-state-count{background:rgba(255,255,255,.14);color:#fff}.lr-results-panel{min-width:0}.lr-results-head{display:flex;align-items:flex-end;justify-content:space-between;gap:24px;margin-bottom:20px}.lr-results-head h2{margin:0;font-size:clamp(28px,3.6vw,46px);line-height:1;letter-spacing:-.055em}.lr-results-head p{margin:8px 0 0;color:#64748b;font-size:14px;line-height:1.55}.lr-map-link{min-height:42px;display:inline-flex;align-items:center;justify-content:center;padding:0 16px;border-radius:999px;background:#071225;color:#fff;text-decoration:none;font-size:13px;font-weight:950;white-space:nowrap}.lr-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(270px,1fr));gap:20px}.lr-card{overflow:hidden;border:1px solid #dbe5f1;border-radius:28px;background:#fff;box-shadow:0 18px 46px rgba(15,23,42,.08)}.lr-cover{height:164px;background:radial-gradient(circle at 22% 12%,rgba(124,58,237,.28),transparent 28%),radial-gradient(circle at 78% 22%,rgba(32,191,210,.28),transparent 30%),linear-gradient(135deg,#eef2ff,#f8fafc);background-size:cover;background-position:center}.lr-card-body{position:relative;padding:0 20px 20px}.lr-avatar{width:72px;height:72px;margin-top:-36px;display:grid;place-items:center;overflow:hidden;border:4px solid #fff;border-radius:22px;background:#071225;color:#fff;box-shadow:0 12px 26px rgba(15,23,42,.14);font-size:20px;font-weight:950;letter-spacing:-.05em}.lr-avatar img{width:100%;height:100%;object-fit:cover;display:block}.lr-card h3{margin:14px 0 0;color:#071225;font-size:21px;line-height:1.05;letter-spacing:-.045em}.lr-headline{min-height:42px;margin:8px 0 0;color:#64748b;font-size:13px;line-height:1.5;font-weight:650}.lr-meta{display:flex;flex-wrap:wrap;gap:8px;margin:16px 0 0}.lr-meta span{display:inline-flex;align-items:center;min-height:28px;padding:0 9px;border-radius:999px;background:#f1f5f9;color:#475569;font-size:11px;font-weight:950}.lr-card-actions{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:18px}.lr-card-actions a{min-height:42px;display:inline-flex;align-items:center;justify-content:center;border-radius:14px;text-decoration:none;font-size:13px;font-weight:950}.lr-store-link{background:#7c3aed;color:#fff}.lr-profile-link{background:#f8fafc;color:#071225;border:1px solid #dbe5f1}.lr-empty,.lr-alert{padding:34px;border:1px solid #dbe5f1;border-radius:28px;background:#fff;box-shadow:0 18px 46px rgba(15,23,42,.07)}.lr-empty h2{margin:0;font-size:30px;letter-spacing:-.05em}.lr-empty p{max-width:620px;margin:12px 0 0;color:#64748b;line-height:1.6}.lr-empty a{display:inline-flex;align-items:center;justify-content:center;min-height:44px;margin-top:18px;padding:0 16px;border-radius:14px;background:#071225;color:#fff;text-decoration:none;font-weight:950}.lr-alert{color:#991b1b;background:#fff1f2;border-color:#fecaca;font-weight:850}@media(max-width:980px){.lr-hero-grid,.lr-layout{grid-template-columns:1fr}.lr-state-sidebar{position:relative;top:auto}.lr-state-list{grid-template-columns:repeat(auto-fill,minmax(130px,1fr));max-height:none}.lr-state-name{display:none}}@media(max-width:680px){.lr-hero{padding:58px 0 34px}.lr-results{padding-top:28px}.lr-results-head{display:block}.lr-map-link{margin-top:14px}.lr-card-actions{grid-template-columns:1fr}.lr-stat-card strong{font-size:38px}}
</style>
    ...
    <div class="lr-container">
      ...
      <div class="lr-hero-grid">
        ...
        <aside class="lr-stat-card" aria-label="Merchant count">
          <strong><?= mg_e((string)($stateCounts[$stateCode] ?? count($merchants))) ?></strong>
