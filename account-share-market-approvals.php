...
$page_scripts = ['/assets/js/account.js', '/assets/js/share-market-program-review-console.js', '/assets/js/share-market-approval-queue.js', '/assets/js/share-market-execution-prep.js'];
...
<section class="mg-app-shell mg-account-app">
  <aside class="mg-app-sidebar mg-account-left">
    ...
    <nav class="mg-app-side-nav mg-account-nav" aria-label="Share Market administration">
      ...
      <a class="is-active" href="/account-share-market-approvals.php"><strong>DAVE Review Console</strong><span>Merchant and series reviews</span></a>
