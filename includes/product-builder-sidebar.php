...
<aside class="mg-builder-sidebar mg-app-sidebar" id="product-builder-sidebar" data-builder-sidebar aria-label="Product builder controls">
  ...
  <div class="mg-builder-sidebar-scroll">
    ...
    <section class="mg-builder-panel is-active" data-builder-panel="product">
      ...
      <div class="mg-builder-field"><label for="merchantName">Merchant or brand</label><input id="merchantName" value="" placeholder="Your business name" maxlength="160" autocomplete="organization"></div>
      <div class="mg-builder-field"><label for="productCategory">Product category</label><select id="productCategory"><option>Voucher</option><option>Prepaid gift</option><option>Local reward</option><option>Workplace perk</option><option>Digital product</option><option>Prize</option><option>Credit</option></select></div>
      ...
      <div class="mg-builder-field"><label for="discount">Offer or bonus</label><input id="discount" value="" placeholder="20% bonus" maxlength="120"></div>
    ...
    <section class="mg-builder-panel" data-builder-panel="gift">
      ...
      <div class="mg-builder-field"><label for="headline">Card headline</label><input id="headline" value="" placeholder="A small gift, already waiting for you." maxlength="180"></div>
      <div class="mg-builder-field"><label for="message">Inside message</label><textarea id="message" maxlength="4000" placeholder="Add a message for the recipient."></textarea></div>
      <div class="mg-builder-field"><label for="recipient">Recipient note</label><input id="recipient" value="" placeholder="For friends, family, co-workers, or customers" maxlength="200"></div>
      <div class="mg-builder-field"><label for="collaborationPrompt">Collaboration prompt</label><textarea id="collaborationPrompt" maxlength="1000" placeholder="Add a message or contribution to help complete this gift."></textarea><small>Used by the Simple Collab template.</small></div>
    ...
    <section class="mg-builder-panel" data-builder-panel="media">
      ...
      <div class="mg-builder-field"><label for="audioLabel">Audio label</label><input id="audioLabel" value="" placeholder="Play the audio greeting" maxlength="120"></div>
      ...
      <div class="mg-builder-field"><label for="videoLabel">Video label</label><input id="videoLabel" value="" placeholder="Watch the video message" maxlength="120"></div>
    </section>
