...
<button class="mg-builder-sidebar-toggle" type="button" data-builder-sidebar-toggle aria-label="Open builder controls" aria-expanded="false">Builder</button>
<aside class="mg-builder-sidebar mg-app-sidebar" id="product-builder-sidebar" data-builder-sidebar aria-label="Product builder controls" aria-hidden="false">
  ...
  <div class="mg-builder-sidebar-scroll">
    ...
    <section class="mg-builder-panel" data-builder-panel="gift">
      ...
      <div class="mg-builder-field" data-builder-types="simple_product greeting_card multimedia_greeting_card"><label for="headline">Card or product headline</label><input id="headline" value="" placeholder="A small gift, already waiting for you." maxlength="180"></div>
      <div class="mg-builder-field" data-builder-types="simple_product greeting_card multimedia_greeting_card"><label for="message">Description or inside message</label><textarea id="message" maxlength="4000" placeholder="Add the product description or recipient message."></textarea></div>
