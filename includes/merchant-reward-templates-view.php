...
<section class="mg-reward-library" data-reward-library-manager>
  ...
  <div class="mg-reward-tab-panels">
        ...
        <aside class="mg-reward-side">
          ...
          <section class="mg-app-panel mg-reward-panel mg-reward-actions">
            ...
            <div class="mg-app-panel-body">
              ...
              <a href="#reward-create" data-reward-tab-trigger="create" data-reward-type-preset="event_reward">Create experience</a>
    ...
    <section class="mg-reward-tab-panel" id="reward-active" data-reward-tab-panel="active" aria-label="Active rewards" hidden>
      <section class="mg-app-panel mg-reward-panel">
        <div class="mg-app-panel-head mg-reward-panel-head">
          <div><span class="mg-eyebrow">Active Rewards</span><h2>Campaign-ready rewards</h2><p>Active templates that can be attached to campaigns, QR pickups, distribution programs, and agent discovery.</p></div>
          <div class="mg-heading-actions"><a class="mg-btn mg-btn-primary" href="#reward-create" data-reward-tab-trigger="create">Create Reward</a></div>
        </div>
        <div class="mg-app-panel-body">
          <div class="mg-product-list mg-reward-list" data-stage12-template-list data-reward-list-filter="active"></div>
        </div>
      </section>
    </section>

    <section class="mg-reward-tab-panel" id="reward-drafts" data-reward-tab-panel="drafts" aria-label="Draft rewards" hidden>
      <section class="mg-app-panel mg-reward-panel">
        <div class="mg-app-panel-head mg-reward-panel-head">
          <div><span class="mg-eyebrow">Drafts</span><h2>Rewards still in setup</h2><p>Draft templates that need status, value, instructions, or liability controls before publishing.</p></div>
          <div class="mg-heading-actions"><a class="mg-btn mg-btn-primary" href="#reward-create" data-reward-tab-trigger="create">Create Reward</a></div>
        </div>
        <div class="mg-app-panel-body">
          <div class="mg-product-list mg-reward-list" data-stage12-template-list data-reward-list-filter="drafts"></div>
        </div>
      </section>
    </section>

    <section class="mg-reward-tab-panel" id="reward-gift-cards" data-reward-tab-panel="gift_cards" aria-label="Gift card rewards" hidden>
      <section class="mg-app-panel mg-reward-panel">
        <div class="mg-app-panel-head mg-reward-panel-head">
          <div><span class="mg-eyebrow">Gift Cards</span><h2>Gift and credit templates</h2><p>Dollar credits and item-based rewards that work as reusable gift assets.</p></div>
          <div class="mg-heading-actions"><a class="mg-btn mg-btn-primary" href="#reward-create" data-reward-tab-trigger="create" data-reward-type-preset="dollar_credit">Create Gift Card</a></div>
        </div>
        <div class="mg-app-panel-body">
          <div class="mg-product-list mg-reward-list" data-stage12-template-list data-reward-list-filter="gift_cards"></div>
        </div>
      </section>
    </section>

    <section class="mg-reward-tab-panel" id="reward-discounts" data-reward-tab-panel="discounts" aria-label="Discount rewards" hidden>
      <section class="mg-app-panel mg-reward-panel">
        <div class="mg-app-panel-head mg-reward-panel-head">
          <div><span class="mg-eyebrow">Discounts</span><h2>Discount reward templates</h2><p>Campaign-ready discounts for newsletters, contests, distribution links, and local promotions.</p></div>
          <div class="mg-heading-actions"><a class="mg-btn mg-btn-primary" href="#reward-create" data-reward-tab-trigger="create" data-reward-type-preset="discount">Create Discount</a></div>
        </div>
        <div class="mg-app-panel-body">
          <div class="mg-product-list mg-reward-list" data-stage12-template-list data-reward-list-filter="discounts"></div>
        </div>
      </section>
    </section>

    <section class="mg-reward-tab-panel" id="reward-experiences" data-reward-tab-panel="experiences" aria-label="Experience rewards" hidden>
      <section class="mg-app-panel mg-reward-panel">
        <div class="mg-app-panel-head mg-reward-panel-head">
          <div><span class="mg-eyebrow">Experiences</span><h2>Experience and event rewards</h2><p>Perks, upgrades, event rewards, and custom experiences for high-value engagement campaigns.</p></div>
          <div class="mg-heading-actions"><a class="mg-btn mg-btn-primary" href="#reward-create" data-reward-tab-trigger="create" data-reward-type-preset="event_reward">Create Experience</a></div>
        </div>
        <div class="mg-app-panel-body">
          <div class="mg-product-list mg-reward-list" data-stage12-template-list data-reward-list-filter="experiences"></div>
        </div>
      </section>
    </section>

    <section class="mg-reward-tab-panel" id="reward-archived" data-reward-tab-panel="archived" aria-label="Archived rewards" hidden>
      <section class="mg-app-panel mg-reward-panel">
        <div class="mg-app-panel-head mg-reward-panel-head">
          <div><span class="mg-eyebrow">Archived</span><h2>Retired reward templates</h2><p>Archived rewards stay visible for audit history without showing up in active campaign setup.</p></div>
          <div class="mg-heading-actions"><a class="mg-btn mg-btn-primary" href="#reward-create" data-reward-tab-trigger="create">Create Reward</a></div>
        </div>
        <div class="mg-app-panel-body">
          <div class="mg-product-list mg-reward-list" data-stage12-template-list data-reward-list-filter="archived"></div>
        </div>
      </section>
    </section>
    ...
    <section class="mg-reward-tab-panel" id="reward-create" data-reward-tab-panel="create" aria-label="Create new reward" hidden>
      <section class="mg-app-panel mg-reward-panel mg-reward-builder-panel" id="reward-builder">
        <div class="mg-app-panel-head mg-reward-panel-head">
          <div><span class="mg-eyebrow">Builder</span><h2>Create new reward</h2><p>Build one wallet-ready reward template. This tab intentionally only shows the reward builder.</p></div>
        </div>
        <div class="mg-app-panel-body">
