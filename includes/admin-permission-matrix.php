...
function mg_admin_permission_matrix(): array
{
    return [
        'pages' => [
            ...
            'admin.screen_recordings' => ['admin.screen_recordings.view', 'admin.screen_recordings.manage'],
            ...
            'admin.admin_agent' => ['admin.admin_agent.view', 'admin.operations_command.view', 'admin.health.view', 'admin.audit.view', 'security.logs.view', 'admin.users.manage'],
            'admin.ai_credit_incidents' => ['admin.ai_credit_incidents.view', 'admin.operations_command.view', 'admin.settings.manage', 'admin.users.manage'],
            ...
            'admin.mcp_connections' => ['admin.mcp_connections.view', 'admin.settings.manage'],
        ...
        'aliases' => [
            ...
            'admin.admin_agent.chat' => ['admin.admin_agent.view', 'admin.operations_command.view', 'admin.users.manage'],
            ...
            'admin.hosted_games.view' => ['admin.settings.manage'],
            'admin.hosted_games.manage' => ['admin.settings.manage'],
            'admin.mcp_connections.view' => ['admin.settings.manage'],
            'admin.mcp_connections.manage' => ['admin.settings.manage'],
