...
if (!function_exists('mg_merchant_navigation_items')) {
    function mg_merchant_navigation_items(): array
    {
        return [
            ...
            'creator_campaigns' => ['Creator Campaigns', 'Brand and creator programs', '/merchant-creator-campaigns.php', 'Products & Engagement'],
            'creator_affiliate_operations' => ['Affiliate Operations', 'Payout policy and reconciliation', '/merchant-creator-affiliate-operations.php', 'Products & Engagement'],
...
if (!function_exists('mg_merchant_navigation_active_key')) {
    function mg_merchant_navigation_active_key(string $active): string
    {
        ...
        $aliases = [
            ...
            'bundle' => 'products',
            'merchant-bundle' => 'products',
            'merchant-bundles' => 'products',
            'merchant-bundle-builder' => 'products',
            'merchant-bundle-invitations' => 'products',
            ...
            'merchant-creator-campaigns' => 'creator_campaigns',
            'merchant-creator-campaign-builder' => 'creator_campaigns',
            'creator_campaign_builder' => 'creator_campaigns',
            'merchant-creator-affiliate-operations' => 'creator_affiliate_operations',
