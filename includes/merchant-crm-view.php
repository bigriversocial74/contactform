...
<div class="mg-crm-modal" data-crm-gift-modal hidden><div class="mg-crm-drawer-backdrop" data-crm-gift-close></div><form class="mg-crm-modal-panel" data-crm-gift-form><header class="mg-crm-drawer-head"><div><span class="mg-eyebrow">Send reward</span><h2 data-crm-gift-title>Choose a reward</h2><p data-crm-gift-subtitle>Select an active reward template for this customer.</p></div><button class="mg-btn mg-btn-soft" type="button" data-crm-gift-close>Close</button></header><label class="mg-crm-field"><span>Reward template</span><select data-crm-gift-template required><option value="">Loading rewards...</option></select></label><label class="mg-crm-field"><span>Optional note</span><textarea data-crm-gift-note maxlength="1000" placeholder="Add a short merchant note..."></textarea></label><p class="mg-form-status" data-crm-gift-status></p><div class="mg-heading-actions"><button class="mg-btn mg-btn-soft" type="button" data-crm-gift-close>Cancel</button><button class="mg-btn" type="submit" data-crm-gift-submit>Send reward</button></div></form></div>