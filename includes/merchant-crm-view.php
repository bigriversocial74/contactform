...
<section class="mg-app-panel" data-merchant-crm-app>
  <div class="mg-app-panel-head">
    <div>
      ...
      <p>Operational contact list with campaign type, account status, reward status, email status, and timeline actions.</p>
    </div>
    <div class="mg-heading-actions">
...
<div class="mg-crm-drawer" data-crm-drawer hidden>
  ...
  <aside class="mg-crm-drawer-panel" role="dialog" aria-modal="true" aria-labelledby="crmTimelineTitle">
    <header class="mg-crm-drawer-head">
      <div>
        <span class="mg-eyebrow" data-crm-drawer-kicker>Campaign timeline</span>
        <h2 id="crmTimelineTitle" data-crm-drawer-title>Contact timeline</h2>
        <p data-crm-drawer-subtitle>Loading…</p>
      </div>
    ...
    <div class="mg-crm-action-row">
      ...
      <button class="mg-btn mg-btn-soft" type="button" data-crm-action="gift">Send gift</button>
