...
<section class="mg-agent-analytics-page" data-merchant-agent-analytics>
  ...
  <section class="mg-agent-analytics-grid is-wide">
    <article class="mg-app-panel mg-agent-analytics-panel"><div class="mg-app-panel-head"><div><h2>By Playbook</h2><p>Which playbooks generate decisions and completed outcomes.</p></div></div><div class="mg-agent-analytics-table" data-aa-playbooks></div></article>
    <article class="mg-app-panel mg-agent-analytics-panel"><div class="mg-app-panel-head"><div><h2>By Customer</h2><p>Customers touched by agent workflow outcomes.</p></div></div><div class="mg-agent-analytics-table" data-aa-customers></div></article>
  </section>

  <section class="mg-agent-analytics-grid is-wide">
    <article class="mg-app-panel mg-agent-analytics-panel"><div class="mg-app-panel-head"><div><h2>By Event Type</h2><p>Raw workflow distribution across the agent event stream.</p></div></div><div class="mg-agent-analytics-table" data-aa-events></div></article>
    <article class="mg-app-panel mg-agent-analytics-panel"><div class="mg-app-panel-head"><div><h2>Daily Trend</h2><p>Recent agent activity by day.</p></div></div><div class="mg-agent-analytics-trend" data-aa-daily></div></article>
  </section>
