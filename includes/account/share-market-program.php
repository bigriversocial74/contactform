...
<section class="mg-app-panel mg-account-pane is-active sm-program" data-account-pane="share-market">
  <section class="sm-hero">
    ...
    <aside class="sm-signal-card" aria-label="Current DAVE share readiness">
      ...
      <div class="sm-signal-value">
        ...
        <div class="sm-stat"><span>DAVE™ Score</span><strong><?= mg_e((string)$score) ?></strong><small><?= mg_e($readiness) ?></small></div>
        <div class="sm-stat"><span>Asset Signal</span><strong><?= mg_e($shareSignal) ?></strong><small>Estimated value per 10k-share pool</small></div>
  ...
  <?php if (!$shareMarketProfile): ?>
    <section class="sm-panel"><h2>No active public profile yet.</h2><p>The Share Market program uses the same DRM signal as the Market Dashboard. Create or publish a profile first, then DAVE™ can calculate readiness, value signal, and launch requirements.</p><div class="sm-action-row"><a class="sm-btn primary" href="/account.php">Open Profile Editor</a></div></section>
  <?php elseif ($shareMarketError): ?>
    <section class="sm-panel"><h2>DAVE™ signal unavailable.</h2><p><?= mg_e($shareMarketError) ?></p></section>
  <?php endif; ?>

  <section class="sm-panel">
    <span class="sm-kicker">Microgifter value stack</span>
    <h2>DRM collects the signal. DAVE™ measures the value. Share Markets make that value usable.</h2>
    <p>This separates data, valuation, and market participation into professional layers. Merchants do not have to participate in the Share Market program to benefit from Microgifter's DRM, CRM, rewards, gift cards, tickets, and commerce tools.</p>
    <div class="sm-stack">
      <div class="sm-stack-card"><b>D</b><strong>DRM — Data Resource Manager</strong><span>Collects attention, engagement, redemption, commerce, distribution, follower, and risk signals.</span></div>
      <div class="sm-stack-card"><b>V</b><strong>DAVE™ — Digital Asset Value Engine</strong><span>Measures how attention becomes action, action becomes redemption, and redemption becomes measurable commerce.</span></div>
      <div class="sm-stack-card"><b>M</b><strong>Share Market Layer</strong><span>Lets approved participants create controlled markets where fans can hold, gift, resell, or redeem utility-backed shares.</span></div>
    </div>
  </section>
  ...
  <section class="sm-grid" aria-label="Program boundaries">
    ...
    <article class="sm-panel"><span class="sm-icon">D</span><h3>Powered by DAVE™</h3><p>Share value is attached to the artist or merchant value profile calculated from Microgifter-visible attention, action, redemption, commerce, followers, and risk.</p></article>
  ...
  <section class="sm-wide">
    <article class="sm-panel sm-dark">
      ...
      <div class="sm-list">
        ...
        <div class="sm-list-item"><b>3</b><div><strong>Attach DAVE™ value</strong><span>DAVE™ uses DRM data to shape pricing, readiness, confidence, and reissue guidance.</span></div><em>DATA</em></div>
  ...
  <section class="sm-wide">
    <article class="sm-panel">
      ...
      <div class="sm-table">
        ...
        <div class="sm-table-row"><div><span>Value</span><strong>DAVE™ score and DRM ticker signal</strong></div><div><span>Current</span><strong><?= mg_e((string)$score) ?> / 100</strong></div><em>Required</em></div>
    ...
    <article class="sm-panel">
      ...
      <div class="sm-table">
        ...
        <div class="sm-table-row"><div><span>Pricing</span><strong>DAVE™ signal + launch price + max per buyer</strong></div><div><span>Resale</span><strong>Off until approved</strong></div><em>Locked</em></div>
  ...
  <section class="sm-final">
    <h2>DAVE™ makes digital asset value measurable before a Share Market ever goes live.</h2>
    <p>DRM collects the signals. DAVE™ measures how attention becomes action, how action becomes redemption, and how redemption becomes measurable commerce. The optional Share Market layer turns that measured value into controlled fan participation.</p>
