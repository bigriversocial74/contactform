...
<section class="sm-approval" data-share-approval-root>
  <header class="sm-approval-head">
    <div>
      ...
      <p>Validated actions enter an append-only review queue. Requesters cannot approve their own actions. Critical actions require two distinct super-administrator approvals. Approved requests still cannot execute until the final Share Market SQL and transaction layer are installed.</p>
    </div>
  ...
  <p class="sm-approval-warning"><strong>Compatibility storage:</strong> approval events are persisted in the existing append-only <code>events</code> table. Share balances, pools, treasuries, series, and holder positions remain untouched.</p>
</section>
...
<div class="sm-approval-modal" data-share-request-modal hidden aria-hidden="true">
  ...
  <section class="sm-approval-dialog" role="dialog" aria-modal="true" aria-labelledby="sm-request-title">
    ...
    <form class="sm-approval-body" data-share-request-form>
      ...
      <p class="sm-approval-warning">The request expires after 24 hours. Submitting creates an approval event only; it does not execute the underlying Share Market action.</p>
  ...
  <section class="sm-approval-dialog" role="dialog" aria-modal="true" aria-labelledby="sm-review-title">
    ...
    <div class="sm-approval-body">
      ...
      <form data-share-decision-form hidden>
        ...
        <div class="sm-approval-form">
          <div class="sm-approval-field is-wide">
            <label for="sm-decision-note">Decision note</label>
            <textarea id="sm-decision-note" name="note" maxlength="1000" required></textarea>
          </div>
          <div class="sm-approval-field">
            <label for="sm-decision-password">Fresh password verification</label>
            <input id="sm-decision-password" name="password" type="password" autocomplete="current-password" required>
          </div>
          <div class="sm-approval-field sm-approval-confirm">
            <label for="sm-decision-confirmation">Typed confirmation</label>
            <span>Type:</span><code data-share-decision-phrase>—</code>
            <input id="sm-decision-confirmation" name="confirmation" autocomplete="off" spellcheck="false" required>
          </div>
        </div>
