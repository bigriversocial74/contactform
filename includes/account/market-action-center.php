...
?>
<?php require __DIR__ . '/market-alerts.php'; ?>
  ...
  <div class="mg-market-action-card-grid">
    <?php foreach ($marketActionCards as $card): ?>
      <article class="mg-market-action-card is-<?= mg_e(strtolower((string)$card['priority'])) ?>">
        <div class="mg-market-action-card-head"><span><?= mg_e((string)$card['priority']) ?></span><h4><?= mg_e((string)$card['title']) ?></h4></div>
        <dl><div><dt>Why this matters</dt><dd><?= mg_e((string)$card['why']) ?></dd></div><div><dt>Expected score impact</dt><dd><?= mg_e((string)$card['score']) ?></dd></div><div><dt>Expected ticker impact</dt><dd><?= mg_e((string)$card['ticker']) ?></dd></div><div><dt>Suggested next step</dt><dd><?= mg_e((string)$card['next']) ?></dd></div></dl>
