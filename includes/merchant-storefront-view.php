...
?>
<section class="mg-storefront-shell" data-storefront-shell>
  <div class="mg-storefront-commandbar">
    <nav class="mg-storefront-tabs" aria-label="Storefront sections">
      <a class="is-active" href="#storefront-overview">Overview</a>
      <a href="#storefront-identity">Public Profile</a>
      <a href="#storefront-identity">Links</a>
      <a href="#storefront-products-panel">Featured Rewards</a>
      <a href="#storefront-preview-panel">QR Preview</a>
      <a href="#storefront-identity">Settings</a>
    </nav>
  ...
  <section class="mg-storefront-kpis" id="storefront-overview" aria-label="Storefront readiness summary">
    <article><span>Readiness</span><strong data-storefront-readiness-score>0%</strong><small>Required setup complete</small></article>
    <article><span>Draft version</span><strong data-storefront-draft-version>—</strong><small>Working revision</small></article>
    <article><span>Published version</span><strong data-storefront-published-version>—</strong><small>Live revision</small></article>
    <article><span>Featured rewards</span><strong data-storefront-product-count>0 selected</strong><small>Visible storefront items</small></article>
    <article><span>Last published</span><strong data-storefront-published-at>Never</strong><small>Publication history</small></article>
  </section>
  ...
  <div class="mg-storefront-workspace mg-hidden" data-storefront-content>
    <div class="mg-storefront-editor-column">
      <section class="mg-app-panel mg-storefront-panel" id="storefront-identity">
        <div class="mg-app-panel-head mg-storefront-panel-head">
          <div>
            <span class="mg-eyebrow">Public presence</span>
            <h2>Storefront identity</h2>
            <p>Control the customer-facing name, address, positioning, media, contact links, and theme.</p>
          </div>
      ...
      <section class="mg-app-panel mg-storefront-panel" id="storefront-products-panel">
        <div class="mg-app-panel-head mg-storefront-panel-head">
          <div>
            <span class="mg-eyebrow">Featured rewards</span>
            <h2>Product placement</h2>
            <p>Choose which published products appear, mark featured products, and control their order.</p>
          </div>
          <a class="mg-btn mg-btn-soft" href="/merchant-products.php">Manage catalog</a>
        </div>
        <div class="mg-app-panel-body">
    ...
    <aside class="mg-storefront-side-column">
      <section class="mg-app-panel mg-storefront-panel mg-storefront-preview-panel" id="storefront-preview-panel">
        <div class="mg-app-panel-head mg-storefront-panel-head"><div><span class="mg-eyebrow">Live preview</span><h2>Draft preview</h2><p>Updates as you edit. It is not public until published.</p></div></div>
        <div class="mg-app-panel-body">
      ...
      <section class="mg-app-panel mg-storefront-panel mg-storefront-readiness-panel">
        <div class="mg-app-panel-head mg-storefront-panel-head is-compact"><div><h2>Publish readiness</h2><p>Required items must be complete before publishing.</p></div></div>
        <div class="mg-app-panel-body">
      ...
      <section class="mg-app-panel mg-storefront-panel mg-storefront-revision-panel">
        <div class="mg-app-panel-head mg-storefront-panel-head is-compact"><div><h2>Revision status</h2><p>Published revisions remain immutable.</p></div></div>
        <div class="mg-app-panel-body">
