...
<section class="mg-ccdv" data-ccdv-merchant>
  <header class="mg-ccdv-head">
    <div><span class="mg-eyebrow">Creator Campaigns · Phase 4</span><h1>Deliverables & Content Review</h1><p>Create contractual deliverables, assign them to active creators, review revisions, and verify publication proof.</p></div>
    <div class="mg-ccdv-actions"><a class="mg-btn mg-btn-ghost" href="/merchant-creator-participation.php">Participation</a><a class="mg-btn mg-btn-soft" href="/merchant-creator-campaigns.php">Campaigns</a><button class="mg-btn mg-btn-primary" type="button" data-ccdv-new>New Deliverable</button></div>
  </header>
  ...
  <section class="mg-ccdv-toolbar">
    <div class="mg-ccdv-tabs"><button class="is-active" data-ccdv-tab="deliverables">Deliverables</button><button data-ccdv-tab="assignments">Assignments</button><button data-ccdv-tab="submissions">Content Review</button></div>
    <form data-ccdv-filters><select name="campaign_id" data-ccdv-campaign><option value="">All campaigns</option></select><select name="status" data-ccdv-status><option value="">All statuses</option></select><button class="mg-btn mg-btn-soft" type="submit">Filter</button><button class="mg-btn mg-btn-ghost" type="button" data-ccdv-sync>Assign Active Deliverables</button></form>
  </section>
  <section class="mg-ccdv-state" data-ccdv-loading><strong>Loading deliverables</strong><span>Preparing campaign assignments and content review.</span></section>
  <section class="mg-ccdv-state mg-hidden" data-ccdv-error><strong>Unable to load Phase 4</strong><span data-ccdv-error-message></span><button class="mg-btn mg-btn-soft" type="button" data-ccdv-retry>Try again</button></section>
  ...
  <dialog class="mg-ccdv-dialog" data-ccdv-review-dialog>
    <section class="mg-ccdv-dialog-card is-review">
      ...
      <form data-ccdv-review-form><input type="hidden" name="submission_id"><input type="hidden" name="expected_lock_version"><label>Merchant feedback<textarea name="feedback" rows="4" maxlength="32000" placeholder="Required for revision requests and rejections"></textarea></label><footer class="mg-ccdv-review-actions"><button class="mg-btn mg-btn-ghost" type="button" data-ccdv-decision="under_review">Start Review</button><button class="mg-btn mg-btn-soft" type="button" data-ccdv-decision="revision_requested">Request Revision</button><button class="mg-btn mg-btn-danger" type="button" data-ccdv-decision="rejected">Reject</button><button class="mg-btn mg-btn-primary" type="button" data-ccdv-decision="approved">Approve</button><button class="mg-btn mg-btn-primary" type="button" data-ccdv-decision="verified">Verify Proof</button></footer></form>
    </section>
  </dialog>
</section>
