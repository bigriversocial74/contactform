...
<section class="mg-merchant-heading mg-loyalty-quest-heading">
  <div>
    ...
    <p>Create, publish, pause, duplicate, complete, archive, and measure merchant-owned Loyalty Quests.</p>
  </div>
...
<section class="mg-campaign-kpis" aria-label="Loyalty Quest metrics">
  ...
  <article><span>Active</span><strong data-lq-kpi-active>—</strong><small>Currently accepting participation</small></article>
...
<section class="mg-app-panel mg-lq-command" data-loyalty-quest-management>
  <div class="mg-app-panel-head">
    <div>
      ...
      <p>Filter by lifecycle state, inspect activity, and apply guarded merchant-scoped actions.</p>
    </div>
    <div class="mg-heading-actions">
