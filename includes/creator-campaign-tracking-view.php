...
<section class="mg-cct-shell" data-cct-creator>
  <header class="mg-cct-head">
    ...
    <div class="mg-action-row"><a class="mg-btn mg-btn-soft" href="/creator-campaign-analytics.php">Performance</a><a class="mg-btn mg-btn-soft" href="/creator-campaign-earnings.php">My Earnings</a><button class="mg-btn mg-btn-primary" type="button" data-cct-new-source>New Tracking Link</button></div>
  </header>
