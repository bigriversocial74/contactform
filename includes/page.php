...
function mg_asset_registry(): array
{
    return [
        'universal-header'=>[
            'styles'=>['/assets/css/universal-header.css','/assets/css/account-menu.css','/assets/css/cart.css','/assets/css/layout-fixes.css','/assets/css/public-header-initial-width.css'],
