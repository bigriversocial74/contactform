        ...
        <pre class="mg-code-panel" data-reveal="up"><span class="gold">POST</span> /v1/distribution/send
{
  ...
  "metadata": {
    "source": <span class="green">"future-demand"</span>
        ...
        <article class="mg-api-flow" data-reveal="up" style="--delay:120ms">
          ...
          <div class="mg-api-flow-row"><span class="mg-api-flow-dot">01</span><p>A merchant or partner app releases a promotional reward.</p></div>
          <div class="mg-api-flow-row"><span class="mg-api-flow-dot">02</span><p>Microgifter sends the reward and connects it to a campaign and customer record.</p></div>
          <div class="mg-api-flow-row"><span class="mg-api-flow-dot">03</span><p>The customer claims, shares, gifts, purchases, or redeems the offer.</p></div>
          <div class="mg-api-flow-row"><span class="mg-api-flow-dot">04</span><p>The merchant verifies redemption and sees which campaign created demand.</p></div>
        </article>
      </div>
    </div>
  </section>
  ...
  <section class="mg-public-bottom-demo" aria-labelledby="mgPublicDemoTitle">
    <div class="mg-public-bottom-demo-inner">
      ...
      <h2 id="mgPublicDemoTitle">See how Microgifter turns promotions into future local demand.</h2>
      <p>Walk through promotional offers, reward distribution, campaign tracking, merchant tools, CRM activity, and the Distribution API in one focused demo.</p>
  ...
  <div class="mg-container">
    <div class="mg-footer-grid">
      <div class="mg-footer-brand" data-reveal="left">
        ...
        <p class="mg-footer-tag">Local rewards. Real results.<br>Powering promotional commerce.</p>
      ...
      <div class="mg-footer-col" data-reveal="left" style="--delay:80ms"><h3>Product</h3><nav><a href="#merchants">Rewards</a><a href="#growth">CRM</a><a href="#growth">Campaigns</a><a href="/pricing.php">Pricing</a></nav></div>
      <div class="mg-footer-col" data-reveal="left" style="--delay:160ms"><h3>Platform</h3><nav><a href="#growth">Distribution API</a><a href="#api-preview">Automation</a><a href="/developer-docs.php">Docs</a><a href="/learn-more.php">Book a Demo</a></nav></div>
