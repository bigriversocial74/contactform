...
.mg-bg-mesh{
  background:linear-gradient(90deg,rgba(0,0,0,.72),rgba(0,0,0,.14) 47%,rgba(0,0,0,.72)),url('images/cosmic_golden_network_on_black.png') center/cover no-repeat!important;
}
