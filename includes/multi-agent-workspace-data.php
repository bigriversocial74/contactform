...
function mg_multi_agent_templates(): array
{
    return [
        ...
        'workplace_rewards' => [
            ...
            'category' => 'coworker',
            'icon' => '▣',
            'description' => 'Coordinate employee recognition and locally funded reward programs through existing merchant distribution authorities.',
            'welcome' => 'Which workplace reward program would you like to review or connect?',
            'prompts' => ['Show workplace reward programs', 'Review reward budgets', 'Connect an existing program'],
            'status' => 'active',
            'merchant_required' => true,
        ],
        'community_fundraising' => [
            ...
            'category' => 'fundraiser',
            'icon' => '◎',
            'description' => 'Coordinate existing fundraisers, contests, giveaways, prizes, and sponsored community programs.',
            'welcome' => 'Which community, contest, giveaway, or fundraiser program would you like to review?',
            'prompts' => ['Show community programs', 'Review contest progress', 'Connect an existing fundraiser'],
            'status' => 'active',
            'merchant_required' => true,
        ],
        'creator_merch' => [
