...
$user=mg_require_admin_page_key('admin.merchant_catalog');
$canViewMerchantCatalog=true;
$page_title='Merchant & Catalog Operations | Microgifter';
$page_section='account';
$header_mode='account';
$page_body_class='mg-admin-merchant-catalog-page';
$page_styles=['/assets/css/admin-shell.css','/assets/css/admin-merchant-catalog.css'];
$page_scripts=['/assets/js/admin-merchant-catalog.js'];
$adminActive='merchant-catalog';
  ...
  <div class="mg-app-workspace mg-admin-workspace">
    <section class="mg-mc-shell" data-mc-root>
      <header class="mg-mc-hero">
        ...
        <div class="mg-mc-hero-actions"><span>Updated <strong data-mc-updated>—</strong></span><button class="mg-btn mg-btn-ghost" type="button" data-mc-refresh disabled>Refresh</button></div>
      </header>
