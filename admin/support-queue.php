...
$page_styles = ['/assets/css/admin-shell.css','/assets/css/admin-support-queue.css','/assets/css/admin-queue-playbooks.css','/assets/css/admin-case-timeline.css','/assets/css/admin-queue-reporting.css','/assets/css/admin-queue-automation.css'];
$page_scripts = ['/assets/js/admin-support-queue.js','/assets/js/admin-sla-routing.js','/assets/js/admin-queue-playbooks.js','/assets/js/admin-case-timeline.js','/assets/js/admin-queue-reporting.js','/assets/js/admin-queue-automation.js'];
    ...
    <section class="mg-admin-support-shell" data-admin-support-queue>
      <header class="mg-admin-support-hero">
        <div>
          ...
          <h1>Support queue</h1>
          <p>Review internal user notes, automation, SLA health, auto-routing, playbooks, case timelines, resolution reporting, due dates, assignments, and review flags across the platform.</p>
        </div>
