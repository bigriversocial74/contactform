...
$page_styles = ['/assets/css/admin-shell.css','/assets/css/admin-support-queue.css','/assets/css/admin-queue-playbooks.css','/assets/css/admin-case-timeline.css'];
$page_scripts = ['/assets/js/admin-support-queue.js','/assets/js/admin-sla-routing.js','/assets/js/admin-queue-playbooks.js','/assets/js/admin-case-timeline.js'];
    ...
    <section class="mg-admin-support-shell" data-admin-support-queue>
      <header class="mg-admin-support-hero">
        <div>
          ...
          <h1>Support queue</h1>
          <p>Review internal user notes, SLA health, auto-routing, playbooks, case timelines, follow-up status, due dates, assignments, and review flags across the platform.</p>
        </div>
