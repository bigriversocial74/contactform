...
$user=mg_require_admin_page_key('admin.lifecycle_health');
$canView=true;
$page_title='Lifecycle Health | Microgifter';
$page_section='account';
$header_mode='account';
$page_body_class='mg-admin-lifecycle-health-page';
$page_styles=['/assets/css/admin-shell.css','/assets/css/admin-system-health.css','/assets/css/admin-lifecycle-health.css'];
$page_scripts=['/assets/js/admin-lifecycle-health.js'];
$adminActive='lifecycle-health';
  ...
  <div class="mg-app-workspace mg-admin-workspace">
    <section class="mg-lifecycle-health-shell" data-lifecycle-health>
      <header class="mg-system-health-hero">
        ...
        <div class="mg-system-health-hero-actions"><span class="mg-system-health-updated">Last checked <strong data-lifecycle-updated>—</strong></span><button class="mg-btn mg-btn-ghost" type="button" data-lifecycle-refresh disabled>Refresh</button></div>
      </header>
