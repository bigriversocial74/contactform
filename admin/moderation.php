...
$user = mg_require_admin_page_key('admin.moderation');
$canViewModeration = true;
$canManageModeration = mg_admin_permission_user_has($user, 'social.moderate')
    || mg_admin_permission_user_has($user, 'admin.profiles.moderation.manage');
