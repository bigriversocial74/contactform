  ...
  <main class="mg-app-workspace mg-admin-workspace">
    <section class="mg-diligence-app" data-investor-diligence data-csrf-token="<?= mg_e($csrfToken) ?>" data-can-manage="<?= $canManage?'1':'0' ?>" data-can-publish="<?= $canPublish?'1':'0' ?>" data-can-engagement="<?= $canEngagement?'1':'0' ?>" data-can-ai="<?= $canAi?'1':'0' ?>">
      <header class="mg-diligence-hero">
        ...
        <div class="mg-diligence-actions"><a class="mg-btn mg-btn-ghost" href="/admin/investor-access-requests.php">Access Requests</a><a class="mg-btn mg-btn-soft" href="/admin/investment-wizard.php">Investment Wizard</a><a class="mg-btn mg-btn-soft" href="/admin/investor-pipeline.php">Investor Pipeline</a><a class="mg-btn mg-btn-primary" href="/admin/investment-closing.php">Closing</a></div>
      </header>
