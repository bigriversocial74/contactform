...
$page_styles = ['/assets/css/admin-shell.css','/assets/css/admin-ops-command.css','/assets/css/admin-ops-incidents.css','/assets/css/admin-ops-reviews.css'];
$page_scripts = ['/assets/js/admin-ops-command.js','/assets/js/admin-ops-reviews.js'];
    ...
    <section class="mg-ops-command-shell" data-ops-command>
      <header class="mg-ops-command-hero">
        <div>
          ...
          <p>Unified visibility for queue health, automation, incident mode, postmortems, SLA status, workload balance, notification urgency, reporting, and critical work across Microgifter admin operations.</p>
        </div>
