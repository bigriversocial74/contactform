...
$page_styles = ['/assets/css/admin-shell.css','/assets/css/admin-ops-command.css','/assets/css/admin-ops-incidents.css','/assets/css/admin-ops-reviews.css','/assets/css/admin-incident-analytics.css','/assets/css/admin-risk-forecast.css'];
$page_scripts = ['/assets/js/admin-ops-command.js','/assets/js/admin-ops-reviews.js','/assets/js/admin-incident-analytics.js','/assets/js/admin-risk-forecast.js'];
    ...
    <section class="mg-ops-command-shell" data-ops-command>
      <header class="mg-ops-command-hero">
        <div>
          ...
          <p>Unified visibility for queue health, automation, incident mode, postmortems, incident analytics, predictive risk forecasts, SLA status, workload balance, notification urgency, reporting, and critical work across Microgifter admin operations.</p>
        </div>
