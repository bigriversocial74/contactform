...
?>
<section class="mg-app-shell mg-admin-app mg-admin-agent-app" data-admin-agent data-csrf-token="<?= mg_e($csrfToken) ?>" data-api-endpoint="/api/admin/admin-agent-phase4.php" data-stream-endpoint="/api/admin/admin-agent-phase4-stream.php" data-phase3-api-endpoint="/api/admin/admin-agent-phase3.php" data-phase3-stream-endpoint="/api/admin/admin-agent-phase3-stream.php" data-phase2-api-endpoint="/api/admin/admin-agent-phase2.php" data-phase2-stream-endpoint="/api/admin/admin-agent-phase2-stream.php">
  ...
  <div class="mg-app-workspace mg-admin-workspace mg-admin-agent-workspace">
    <main class="mg-admin-agent-main">
      <section class="mg-admin-agent-topbar">
        <div>
          <span class="mg-admin-agent-eyebrow">Protected reliability command layer · Phase 4</span>
          <h1>Main Admin Agent</h1>
          <p>Maintenance governance, deployment risk, historical reliability, capacity forecasting, incident learning, prevention follow-ups, and controlled recovery.</p>
        </div>
        ...
        <div class="mg-personal-agent-chat-stream mg-admin-agent-chat-stream">
          <article class="mg-personal-agent-message is-assistant is-intro mg-admin-agent-intro">
            <div class="mg-admin-agent-intro-head">
              <div>
                ...
                <h2 class="mg-personal-agent-intro-greeting">Reliability governance is ready, <?= mg_e($displayName) ?>.</h2>
              </div>
              <span class="mg-admin-agent-systematic">Database-first · No AI credits</span>
            </div>
            <p>Ask what changed, whether a deployment is risky, which services are consuming error budget, what capacity is trending toward failure, what an incident taught us, or which prevention action is ready for approval. Root-cause statements remain evidence-ranked hypotheses, and every mutation remains review-gated.</p>
          ...
          <div class="mg-agent-chat-feed mg-admin-agent-feed" data-admin-agent-feed aria-live="polite">
            <div class="mg-agent-chat-empty">
              ...
              <p>Maintenance, deployment risk, reliability history, capacity forecasts, incident learning, service health, and review-ready prevention actions will appear here.</p>
            </div>
          </div>
        </div>
      </section>
    ...
    <form class="mg-merchant-agent-composer mg-admin-agent-composer" data-admin-agent-form>
      <div class="mg-merchant-agent-composer-context">
        <span><kbd>A</kbd> Admin command mode · <span data-admin-agent-context>All systems · Reliability-aware · Review-gated execution</span></span>
        <span>Incident and prevention actions require approval and exact typed confirmation</span>
      </div>
      <div class="mg-merchant-agent-composer-row">
        ...
        <textarea data-admin-agent-textarea name="message" rows="1" maxlength="4000" placeholder="Ask about maintenance, change risk, reliability, capacity, incident learning, release safety, or approved recovery…" aria-label="Message the Main Admin Agent" required></textarea>
  ...
  <aside class="mg-agent-chat-right mg-admin-agent-drawer" id="admin-agent-drawer" aria-label="Main Admin Agent controls" data-admin-agent-drawer aria-hidden="true">
    <div class="mg-agent-drawer-head">
      <div><strong>Main Admin Agent controls</strong><small>Phase 4 reliability governance</small></div>
    ...
    <section class="mg-admin-agent-rail-section is-phase4">
      <header><strong>Maintenance windows</strong><span data-admin-agent-maintenance-count>0</span></header>
      <div data-admin-agent-maintenance class="mg-admin-agent-rail-list"></div>
    </section>

    <section class="mg-admin-agent-rail-section is-phase4">
      <header><strong>Deployment change risk</strong><span data-admin-agent-change-risk-count>0</span></header>
      <div data-admin-agent-change-risks class="mg-admin-agent-rail-list"></div>
    </section>

    <section class="mg-admin-agent-rail-section is-phase4">
      <header><strong>Reliability scorecards</strong><span data-admin-agent-reliability-count>0</span></header>
      <div data-admin-agent-reliability class="mg-admin-agent-rail-list"></div>
    </section>

    <section class="mg-admin-agent-rail-section is-phase4">
      <header><strong>Capacity forecasts</strong><span data-admin-agent-capacity-count>0</span></header>
      <div data-admin-agent-capacity class="mg-admin-agent-rail-list"></div>
    </section>

    <section class="mg-admin-agent-rail-section is-phase4">
      <header><strong>Incident learning</strong><span data-admin-agent-learning-count>0</span></header>
      <div data-admin-agent-learning class="mg-admin-agent-rail-list"></div>
    </section>

    <section class="mg-admin-agent-rail-section is-phase4">
      <header><strong>Prevention follow-ups</strong><span data-admin-agent-prevention-count>0</span></header>
      <div data-admin-agent-prevention class="mg-admin-agent-rail-list"></div>
    </section>
