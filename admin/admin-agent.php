...
<section class="mg-app-shell mg-admin-app mg-admin-agent-app" data-admin-agent data-csrf-token="<?= mg_e($csrfToken) ?>" data-api-endpoint="/api/admin/admin-agent-phase5.php" data-stream-endpoint="/api/admin/admin-agent-phase5-stream.php" data-phase4-api-endpoint="/api/admin/admin-agent-phase4.php" data-phase4-stream-endpoint="/api/admin/admin-agent-phase4-stream.php" data-phase3-api-endpoint="/api/admin/admin-agent-phase3.php" data-phase3-stream-endpoint="/api/admin/admin-agent-phase3-stream.php" data-phase2-api-endpoint="/api/admin/admin-agent-phase2.php" data-phase2-stream-endpoint="/api/admin/admin-agent-phase2-stream.php">
  ...
  <div class="mg-app-workspace mg-admin-workspace mg-admin-agent-workspace">
    <main class="mg-admin-agent-main">
      <section class="mg-admin-agent-topbar">
        <div>
          <span class="mg-admin-agent-eyebrow">Protected continuity command layer · Phase 5</span>
          <h1>Main Admin Agent</h1>
          <p>Recovery objectives, validator evidence, restore drills, dependency-aware recovery plans, continuity scorecards, recovery gaps, and controlled evidence approval.</p>
        </div>
        ...
        <div class="mg-personal-agent-chat-stream mg-admin-agent-chat-stream">
          <article class="mg-personal-agent-message is-assistant is-intro mg-admin-agent-intro">
            <div class="mg-admin-agent-intro-head">
              <div>
                ...
                <h2 class="mg-personal-agent-intro-greeting">Recovery assurance is ready, <?= mg_e($displayName) ?>.</h2>
              </div>
              <span class="mg-admin-agent-systematic">Database-first · No AI credits</span>
            </div>
            <p>Ask whether recovery objectives are reviewed, whether backup evidence is current, which drills are overdue, which recovery plans are ready, or which continuity gaps require action. The Admin Agent records and evaluates evidence; it does not perform infrastructure recovery.</p>
          ...
          <div class="mg-agent-chat-feed mg-admin-agent-feed" data-admin-agent-feed aria-live="polite">
            <div class="mg-agent-chat-empty">
              ...
              <p>Recovery objectives, evidence, drills, plans, continuity scores, recovery gaps, reliability governance, and live findings will appear here.</p>
            </div>
          </div>
        </div>
      </section>
    ...
    <form class="mg-merchant-agent-composer mg-admin-agent-composer" data-admin-agent-form>
      <div class="mg-merchant-agent-composer-context">
        <span><kbd>A</kbd> Admin command mode · <span data-admin-agent-context>All systems · Continuity-aware · Review-gated execution</span></span>
        <span>Evidence approval requires review and exact typed confirmation</span>
      </div>
      <div class="mg-merchant-agent-composer-row">
        ...
        <textarea data-admin-agent-textarea name="message" rows="1" maxlength="4000" placeholder="Ask about recovery objectives, backup evidence, drills, plans, continuity gaps, reliability, or approved evidence review…" aria-label="Message the Main Admin Agent" required></textarea>
  ...
  <aside class="mg-agent-chat-right mg-admin-agent-drawer" id="admin-agent-drawer" aria-label="Main Admin Agent controls" data-admin-agent-drawer aria-hidden="true">
    <div class="mg-agent-drawer-head">
      <div><strong>Main Admin Agent controls</strong><small>Phase 5 recovery assurance</small></div>
