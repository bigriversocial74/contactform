...
$page_section='admin';
$header_mode='account';
$adminPage='loyalty_quest_operations';
$adminSectionPermission=mg_admin_section_permission($adminPage);
$page_styles=['/assets/css/admin.css','/assets/css/admin-command-center.css','/assets/css/admin-loyalty-quests.css'];
$page_scripts=['/assets/js/admin-loyalty-quests.js'];
require dirname(__DIR__) . '/includes/header.php';
?>
<div class="mg-admin-shell">
