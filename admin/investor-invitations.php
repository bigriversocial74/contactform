    ...
    <section class="mg-invites-admin" data-admin-investor-invitations data-csrf-token="<?= mg_e($csrfToken) ?>" data-can-manage="<?= $canManage ? '1' : '0' ?>" data-schema-ready="<?= $ready ? '1' : '0' ?>" data-migration="<?= mg_e(MG_INVESTOR_INVITATION_MIGRATION) ?>">
      ...
      <div class="mg-invites-layout">
        <section class="mg-investment-panel mg-invites-compose">
          ...
          <form class="mg-investment-form" data-invitation-create-form>
            <div class="mg-field-grid">
              ...
              <label><span>Expires after</span><select name="expires_in_days"><option value="7">7 days</option><option value="14" selected>14 days</option><option value="30">30 days</option></select></label>
            </div>
            ...
            <p class="mg-invite-delivery-note">Microgifter attempts email delivery immediately and also returns the one-time secure link for controlled manual delivery.</p>
        ...
        <section class="mg-investment-panel mg-invites-list-panel">
          ...
          <form class="mg-investment-filter" data-invitations-filter><label>Search<input name="q" placeholder="Email, name, or firm"></label><label>Status<select name="status"><option value="">All statuses</option><option value="created">Created</option><option value="sent">Sent</option><option value="viewed">Viewed</option><option value="accepted">Accepted</option><option value="expired">Expired</option><option value="revoked">Revoked</option></select></label><button class="mg-btn mg-btn-soft" type="submit">Apply</button></form>
