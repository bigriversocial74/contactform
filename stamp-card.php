...
<section class="mg-rl-page mg-rl-campaign-foundation mg-rl-interactive mg-rl-stamp mg-rl-compact-campaign<?= $previewMode ? ' is-merchant-preview' : '' ?><?= $closed ? ' is-campaign-closed' : '' ?>" data-public-campaign-page data-stamp-card-experience data-campaign-state="<?= mg_e((string)$campaignState['code']) ?>" data-campaign-mode="<?= mg_e($campaignMode) ?>"<?= $previewMode ? ' data-merchant-campaign-preview' : '' ?>>
  ...
  <div class="mg-rl-wrap">
    <div class="mg-rl-left">
      ...
      <div class="mg-rl-bottom mg-stamp-summary mg-stamp-summary-cards" data-campaign-foundation-cards>
        <article class="mg-rl-card mg-stamp-summary-card mg-stamp-item-card">
        ...
        <article class="mg-rl-card mg-stamp-summary-card mg-stamp-status-card" data-stamp-results-updates>
