...
$page_title = 'Share Market Operations Handoff | Microgifter';
$page_section = 'account';
$header_mode = 'account';
$page_styles = ['/assets/css/admin-dashboard.css', '/assets/css/share-market-candidate-packet.css'];
$page_scripts = ['/assets/js/account.js', '/assets/js/share-market-operations-handoff.js'];
...
<section class="mg-app-shell mg-account-app">
  ...
  <main class="mg-app-workspace mg-account-main">
    <section class="sm-packet" data-share-ops-root>
      <header class="sm-packet-head">
        <div>
          <h1>Operations Handoff Packet</h1>
          <p>Printable read-only packet for a reviewed Buy-In handoff archive.</p>
        </div>
        <div class="sm-packet-actions">
          <a class="btn" href="/account-share-market-execution-audit.php">Back to audit console</a>
          <button class="primary" type="button" data-share-ops-print>Print packet</button>
          <button type="button" data-share-ops-download>Download JSON</button>
        </div>
      </header>
      <div class="sm-packet-status" data-share-ops-status>Loading operations handoff packet…</div>
      <section class="sm-packet-grid" data-share-ops-summary></section>
      <section class="sm-packet-section"><h2>Checklist</h2><div class="sm-packet-list" data-share-ops-checks></div></section>
      <section class="sm-packet-section"><h2>Evidence summary</h2><div class="sm-packet-grid" data-share-ops-evidence></div></section>
      <section class="sm-packet-section"><h2>Packet JSON</h2><pre class="sm-packet-json" data-share-ops-json>{}</pre></section>
    </section>
  </main>
</section>
