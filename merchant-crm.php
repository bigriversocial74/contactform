...
$header_mode = 'account';
$page_styles = ['/assets/css/merchant-workspace.css','/assets/css/merchant-crm.css','/assets/css/communications.css','/assets/css/merchant-crm-retention-playbooks.css','/assets/css/merchant-crm-contact-stats.css','/assets/css/merchant-crm-contact-threads.css','/assets/css/merchant-crm-action-center.css','/assets/css/merchant-crm-contact-cards.css','/assets/css/merchant-crm-contact-cards-polish.css','/assets/css/merchant-crm-real-actions-column.css'];
...
echo '<scr' . 'ipt src="/assets/js/merchant-crm-contact-layout-polish.js" defer></scr' . 'ipt>';
