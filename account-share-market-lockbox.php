...
$page_title = 'DAVE Lockbox Review | Microgifter';
...
<section class="mg-app-shell mg-account-app">
  <aside class="mg-app-sidebar mg-account-left">
    ...
    <nav class="mg-app-side-nav mg-account-nav" aria-label="Share Market administration">
      ...
      <a href="/account-share-market-approvals.php"><strong>DAVE Review Console</strong><span>Merchant, credit, readiness, and series reviews</span></a>
      <a href="/account-share-market-execution-audit.php"><strong>Audit Review</strong><span>Evidence and preflight records</span></a>
      <a class="is-active" href="/account-share-market-lockbox.php"><strong>DAVE Lockbox</strong><span>Final locked readiness packets</span></a>
  ...
  <main class="mg-app-workspace mg-account-main">
    <section class="sm-audit" data-share-audit-root>
      <header class="sm-audit-head"><div><h2>DAVE Lockbox</h2><p>Admin-only locked evidence packets for series marked ready for final review. This page is read-only and does not change live market state.</p></div></header>
      <p class="sm-audit-note"><strong>Locked:</strong> final legal/operator review, maker-checker signoff, and a separate release are required before any live action.</p>
    </section>
  </main>
</section>
