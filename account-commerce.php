...
$page_scripts=['/assets/js/account-commerce.js','/assets/js/account-orders.js','/assets/js/account-sidebar.js'];
$accountView='overview';
require __DIR__.'/includes/header.php';
?>
<section class="mg-account-page" data-account-commerce-overview>
