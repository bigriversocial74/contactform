...
<div class="wrap">
  <main>
    <section class="hero">
      <div>
        ...
        <div class="actions">
          ...
          <?php endif; ?>
          <a class="btn secondary" href="demo.php">View developer demo</a>
          <a class="btn secondary" href="start.php">Open launcher</a>
        </div>
      </div>
    ...
    <section class="public-links">
      <a href="demo.php">Demo overview<small>Partner-facing product explanation.</small></a>
      <a href="how-it-works.php">How it works<small>API lifecycle and ownership map.</small></a>
      <a href="deployment-checklist.php">Checklist<small>Demo handoff readiness.</small></a>
      <a href="api-examples.php">API examples<small>Copy-ready request examples.</small></a>
    </section>
  </main>
</div>
</body>
