...
<style>
.lq-launch-hero{display:grid;grid-template-columns:minmax(0,1.1fr) minmax(300px,.9fr);gap:22px;align-items:stretch}.lq-launch-big{background:linear-gradient(135deg,#211816,#4b1729);color:#fff;border-radius:14px;padding:30px;box-shadow:var(--lq-shadow)}.lq-launch-big h1{font-size:clamp(34px,5vw,62px);line-height:.95;letter-spacing:-.07em;margin:12px 0}.lq-launch-big p{color:#ffe6ef;max-width:780px}.lq-launch-card{background:#fff;border:1px solid var(--lq-border);border-radius:14px;padding:22px;box-shadow:var(--lq-shadow)}.lq-launch-progress{height:12px;background:#f1f5f9;border-radius:999px;overflow:hidden}.lq-launch-progress span{display:block;height:100%;background:var(--lq-pink);border-radius:999px}.lq-launch-steps{display:grid;gap:12px;margin-top:22px}.lq-launch-step{display:grid;grid-template-columns:34px minmax(0,1fr) auto;gap:12px;align-items:center;background:#fff;border:1px solid var(--lq-border);border-radius:12px;padding:14px}.lq-launch-step b{width:34px;height:34px;border-radius:999px;display:grid;place-items:center;background:#fff1f5;color:var(--lq-pink)}.lq-launch-step.done b{background:#e9f9ef;color:#137a3a}.lq-launch-step h3{margin:0;font-size:15px}.lq-launch-step p{margin:4px 0 0;color:var(--lq-muted);font-size:13px}.lq-launch-links{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin-top:22px}.lq-launch-link{background:#fff;border:1px solid var(--lq-border);border-radius:12px;padding:16px;text-decoration:none;color:var(--lq-text);box-shadow:var(--lq-shadow)}.lq-launch-link strong{display:block;margin-bottom:6px}.lq-launch-link span{color:var(--lq-muted);font-size:13px}@media(max-width:960px){.lq-launch-hero,.lq-launch-links{grid-template-columns:1fr}.lq-launch-step{grid-template-columns:34px minmax(0,1fr)}}
</style>
</head>
<body class="lq-portal">
<div class="lq-shell">
<header class="lq-topbar"><div class="lq-brand"><span class="lq-logo">LQ</span><span>Local Quest</span></div><div class="lq-top-actions"><a class="lq-upgrade" href="developer-starter.php">Developer Starter</a><a class="lq-upgrade" href="api-examples.php">API Examples</a></div></header>
<aside class="lq-sidebar"><a class="lq-side-link active" href="start.php"><span class="lq-side-icon">▶</span><span class="lq-side-label">Launcher</span></a><a class="lq-side-link" href="index.php"><span class="lq-side-icon">⌂</span><span class="lq-side-label">Quest board</span></a><a class="lq-side-link" href="wallet.php"><span class="lq-side-icon">◉</span><span class="lq-side-label">Wallet</span></a><a class="lq-side-link" href="developer-starter.php"><span class="lq-side-icon">API</span><span class="lq-side-label">Developer Starter</span></a><a class="lq-side-link" href="webhook.php"><span class="lq-side-icon">◷</span><span class="lq-side-label">Webhook status</span></a><a class="lq-side-link" href="admin-developer-readiness.php"><span class="lq-side-icon">QA</span><span class="lq-side-label">Admin readiness</span></a></aside>
<main class="lq-main">
<section class="lq-launch-hero">
  <div class="lq-launch-big"><span class="lq-eyebrow">Microgifter starter app</span><h1>Run the full Local Quest API demo.</h1><p>This launcher turns the demo into a guided outside-developer proof: setup, sign in, link, quest, reward issue, wallet claim, webhook verification, and launch QA.</p><div class="lq-actions"><a class="lq-btn primary" href="developer-starter.php">Open Developer Starter</a><a class="lq-btn soft" href="api-examples.php">Copy API examples</a></div></div>
...
<section class="lq-launch-links"><a class="lq-launch-link" href="signin.php"><strong>Participant sign in</strong><span>Create the third-party app user.</span></a><a class="lq-launch-link" href="index.php"><strong>Quest board</strong><span>Complete QR/location tasks.</span></a><a class="lq-launch-link" href="wallet.php"><strong>Reward wallet</strong><span>Refresh status and claim.</span></a><a class="lq-launch-link" href="admin-developer-readiness.php"><strong>Admin readiness</strong><span>Review app-level launch signals.</span></a></section>
</main>
</div>
</body>
</html>
