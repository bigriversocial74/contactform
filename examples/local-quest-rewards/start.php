...
$steps = [
    ['label'=>'Review public demo overview','done'=>is_file(__DIR__ . '/demo.php'),'href'=>'demo.php','detail'=>'Partner-facing explanation of the Local Quest example app.'],
...
<section class="lq-launch-links"><a class="lq-launch-link" href="demo.php"><strong>Demo overview</strong><span>Partner-facing product explanation.</span></a><a class="lq-launch-link" href="how-it-works.php"><strong>How it works</strong><span>API lifecycle and ownership map.</span></a><a class="lq-launch-link" href="deployment-checklist.php"><strong>Checklist</strong><span>Handoff readiness review.</span></a><a class="lq-launch-link" href="api-examples.php"><strong>API examples</strong><span>Copy request examples.</span></a><a class="lq-launch-link" href="webhook-tools.php"><strong>Webhook tools</strong><span>Generate signed test payloads.</span></a><a class="lq-launch-link" href="admin-demo-tools.php"><strong>Demo seed tools</strong><span>Prepare a handoff demo.</span></a></section>
</main>
</div>
</body>
</html>
